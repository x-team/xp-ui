...
type Props = {
  ...
  initialSelectedSkills: Array<SkillOption>,
  disabled?: boolean,
  isInvalid?: boolean,
...
class CreatableSkillsSelector extends Component<Props, State> {
  state: State = {
    selectedSkills: this.props.initialSelectedSkills || []
  }
...
export default CreatableSkillsSelector
