...
storiesOf('UI Components|Copy To Clipboard', module)
  .add('basic usage', () => (
    <Body>
...
storiesOf('UI Components|Copy To Clipboard/Tooltip', module)
  .add('default', () => (
    <Body>
      <Tooltip />
    </Body>
...
storiesOf('UI Components|Copy To Clipboard/Debug', module)
