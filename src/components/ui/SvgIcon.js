...
export type Icon = 'cog' | 'head' | 'webcam' | 'message' | 'terminal' | 'diamond' | 'talking' | 'trophy' | 'plus' | 'minus' | 'calendar' | 'trashcan' | 'trashcanAlt' | 'x' | 'add' | 'triangleup' | 'triangledown' | 'hamburger' | 'magnifier' | 'edit' | 'check' | 'paperplane' | 'archive' | 'dock'
    ...
    dock: (
      <svg width='12px' height='13px' viewBox='0 0 12 13'>
        <g stroke='none' strokeWidth='10' fill='none' fillRule='evenodd'>
          <g className={fillClassName} transform='translate(-7.000000, -7.000000)' fill='#FFFFFF'>
