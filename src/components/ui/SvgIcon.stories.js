...
storiesOf('Core Components|SvgIcon', module)
  .add('basic color', () => (
    <div>
      <SvgIcon icon='cog' />
      <SvgIcon icon='head' />
  ...
  .add('text gray color', () => (
    <div>
      ...
      <SvgIcon icon='webcam' color='text' />
      <SvgIcon icon='message' color='text' />
...
storiesOf('Core Components|SvgIcon/Debug', module)
