...
var upsertCss = __webpack_require__(23);
var uniquifyName = __webpack_require__(24);
...
var _webfontloader = __webpack_require__(22);
...
_webfontloader2.default.load({
  google: {
    families: ['Open Sans:800,400', 'Source Sans Pro:300,700']
  }
});
...
var getIcon = function getIcon(_ref) {
  ...
  var colors = {
    default: _theme2.default.defaultBorder,
    inverted: _theme2.default.invertedBorder,
    monochrome: _theme2.default.monochromeBorder
  };
...
var Root = _elem2.default.section(cmz.named('AutoUI_Text-21', /*cmz|*/'\n  & {\n    white-space: pre-line;\n    margin: 0;\n    clear: both;\n    overflow: hidden;\n  }\n' /*|cmz*/));

var Heading = _elem2.default.h1(cmz.named('AutoUI_Text-30', typo.family.heading, /*cmz|*/'\n  & {\n    padding-bottom: 20px;\n  }\n  ' /*|cmz*/));

var SubHeading = _elem2.default.h2(cmz.named('AutoUI_Text-39', /*cmz|*/'\n  font-weight: 600;\n  font-size: 28px;\n  letter-spacing: 1px;\n  font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif;\n  text-transform: uppercase;\n' /*|cmz*/));

var Level = _elem2.default.p(cmz.named('AutoUI_Text-47', '\n  color: ' + _theme2.default.red + ';\n  font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif;\n  font-size: 22px;\n  font-weight: 500;\n'));

var Content = _elem2.default.div(cmz.named('AutoUI_Text-54', typo.family.base, /*cmz|*/'\n  & {\n    margin: 35px 0;\n  }\n  &, & * {\n    font-size: 24px;\n    line-height: 1.3em;\n  }\n' /*|cmz*/));

var centerAlign = cmz.named('AutoUI_Text-66', /*cmz|*/'\n  & {\n    text-align: center;\n  }\n' /*|cmz*/);

var contentDividerLeft = cmz.named('AutoUI_Text-72', typo.family.divider, /*cmz|*/'\n  &:after {\n    left: 3%;\n    top: -30px;\n  }\n' /*|cmz*/);

var contentDividerCenter = cmz.named('AutoUI_Text-79', typo.family.divider, /*cmz|*/'\n  &:after {\n    left: 50%;\n    top: -30px;\n  }\n' /*|cmz*/);
...
var Text = function (_PureComponent) {
  ...
  _createClass(Text, [{
    ...
    value: function render() {
      ...
      return Root(isCentered ? { className: centerAlign } : {}, heading && Heading(heading), subHeading && SubHeading(subHeading), level && Level(level), Content(hasDivider ? { className: isCentered ? contentDividerCenter : contentDividerLeft } : {}, content));
    }
  }]);
...
var baseStyles = {
  root: cmz.named('AutoUI_Button-26', '\n    & {\n      background: transparent;\n      border-radius: 0;\n      border: 2px solid transparent;\n      color: ' + _theme2.default.white + ';\n      cursor: pointer;\n      display: inline-block;\n      font-weight: 400;\n      line-height: 1.5;\n      outline: none;\n      margin: .15em auto;\n      padding: 1.25em 3.5em;\n      text-decoration: none;\n      text-transform: uppercase;\n      transition: all .3s ease-out;\n      white-space: nowrap;\n    }\n\n    & span {\n      font-family: \'Open Sans\', sans-serif;\n    }\n\n    &:hover {\n      background-color: ' + _theme2.default.white + ';\n      color: ' + _theme2.default.redHighlight + ';\n    }\n  ')

  // Color options
};var colorStyles = {
  monochrome: cmz.named('AutoUI_Button-58', baseStyles.root, '\n    & {\n      background-color: ' + _theme2.default.black + ';\n      border-color: ' + _theme2.default.black + ';\n      color: ' + _theme2.default.white + ';\n    }\n\n    &.outlined {\n      color: ' + _theme2.default.black + '\n    }\n\n    &:hover {\n      background-color: ' + _theme2.default.blackHighlight + ';\n      border-color: ' + _theme2.default.blackHighlight + ';\n      color: ' + _theme2.default.white + ';\n    }\n  '),

  normal: cmz.named('AutoUI_Button-77', baseStyles.root, '\n    & {\n      background-color: ' + _theme2.default.redHighlight + ';\n      border-color: ' + _theme2.default.redHighlight + ';\n      color: ' + _theme2.default.white + ';\n    }\n\n    &.outlined {\n      color: ' + _theme2.default.redHighlight + '\n    }\n\n    &:hover {\n      background-color: ' + _theme2.default.red + ';\n      border-color: ' + _theme2.default.red + ';\n      color: ' + _theme2.default.white + ';\n    }\n  ')

  // Size options
};var sizeStyles = {
  normal: cmz.named('AutoUI_Button-99', /*cmz|*/'\n    font-size: .75em;\n  ' /*|cmz*/),

  large: cmz.named('AutoUI_Button-103', typo.family.action, /*cmz|*/'\n      font-size: 1em;\n    ' /*|cmz*/),

  small: cmz.named('AutoUI_Button-110', /*cmz|*/'\n    font-size: .65em;\n  ' /*|cmz*/),

  block: cmz.named('AutoUI_Button-114', /*cmz|*/'\n    display: block;\n    margin: 10px auto;\n    width: 200px;\n  ' /*|cmz*/)

  // Button variations
};var extraStyles = {
  disabled: cmz.named('AutoUI_Button-123', '\n    &, &:hover {\n      background: ' + _theme2.default.lightGray + ';\n      border-color: transparent;\n      color: ' + _theme2.default.white + ';\n      pointer-events: none;\n    }\n  '),

  outlined: cmz.named('AutoUI_Button-132', '\n    & {\n      background-color: transparent;\n    }\n\n    &.' + colorStyles.normal + ' {\n      color: ' + _theme2.default.redHighlight + ';\n    }\n\n    &.' + colorStyles.monochrome + ' {\n      color: ' + _theme2.default.black + ';\n    }\n  ')
};
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'size', 'color', 'outlined', 'disabled', 'component', 'children']);

      var colorClassName = colorStyles[color] || '';
      var sizeClassName = sizeStyles[size] || '';
      var extraClassName = [outlined && extraStyles.outlined, outlined && 'outlined', disabled && extraStyles.disabled].filter(Boolean).join(' ');
...
var animatedStyles = {
  timeline: cmz.named('AutoUI_RoadmapTimelineElement-13', '\n    & {\n      position: relative\n      height: 100%\n      min-height: 20px\n    }\n\n    &:before {\n      /* this is the vertical line */\n      content: \'\'\n      position: absolute\n      top: 17px\n      left: 7px\n      overflow: hidden\n      width: 2px\n      height: 100%\n      background: ' + _theme2.default.offwhite + '\n      animation: process .6s linear forwards\n    }\n  '),
  timelineActive: cmz.named('AutoUI_RoadmapTimelineElement-33', '\n    &:before {\n      background: ' + _theme2.default.red + '\n    }\n  '),
  checkmarkBox: cmz.named('AutoUI_RoadmapTimelineElement-38', /*cmz|*/'\n    width: 16px\n    position: absolute\n    top: 0\n    left: 0\n  ' /*|cmz*/),
  checkmarkCircle: cmz.named('AutoUI_RoadmapTimelineElement-44', '\n    stroke-dasharray: 166\n    stroke-dashoffset: 0\n    stroke-width: 3\n    stroke-miterlimit: 10\n    stroke: ' + _theme2.default.offwhite + '\n  '),
  checkmarkCircleActive: cmz.named('AutoUI_RoadmapTimelineElement-51', '\n    & {\n      stroke: ' + _theme2.default.red + '\n      fill: none\n      animation: stroke .6s cubic-bezier(.65, 0, .45, 1) forwards\n    }\n\n    @keyframes stroke {\n      100% {\n        stroke-dashoffset: 0\n      }\n    }\n  '),
  checkmark: cmz.named('AutoUI_RoadmapTimelineElement-64', '\n    & {\n      border-radius: 50%\n      display: block\n      stroke-width: 2\n      stroke: ' + _theme2.default.white + '\n      stroke-miterlimit: 10\n      margin: 10% auto\n      box-shadow: inset 0 0 0 ' + _theme2.default.red + '\n      animation: fill .4s ease-in-out .4s forwards, scale .4s ease-in-out .4s both\n    }\n\n    @keyframes fill {\n      100% {\n        box-shadow: inset 0 0 0 30px ' + _theme2.default.red + '\n      }\n    }\n  '),
  checkmarkCheck: cmz.named('AutoUI_RoadmapTimelineElement-82', /*cmz|*/'\n    transform-origin: 50% 50%\n    stroke-dasharray: 48\n    stroke-dashoffset: 48\n    animation: stroke .2s cubic-bezier(.65, 0, .45, 1) .4s forwards\n  ' /*|cmz*/)
};
...
exports.SolutionForm = exports.FooterList = exports.FooterBrands = exports.Footer = exports.XIcon = exports.VideoPlayer = exports.Text = exports.SvgIcon = exports.RoadmapTimelineElement = exports.RoadmapLevel = exports.RoadmapHero = exports.Roadmap = exports.Milestones = exports.HorizontalRuler = exports.HeaderBar = exports.ErrorBox = exports.CollapsibleSection = exports.Button = exports.ApplicantListFilter = exports.ApplicantBadge = undefined;

var _ApplicantBadge = __webpack_require__(13);

var _ApplicantBadge2 = _interopRequireDefault(_ApplicantBadge);

var _ApplicantListFilter = __webpack_require__(25);
...
var _CollapsibleSection = __webpack_require__(26);

var _CollapsibleSection2 = _interopRequireDefault(_CollapsibleSection);

var _ErrorBox = __webpack_require__(37);
...
var _XIcon = __webpack_require__(48);
...
var _FooterBrands = __webpack_require__(51);

var _FooterBrands2 = _interopRequireDefault(_FooterBrands);

var _FooterList = __webpack_require__(52);

var _FooterList2 = _interopRequireDefault(_FooterList);

var _SolutionForm = __webpack_require__(53);
...
var cx = {
  isActive: cmz.named('AutoUI_ApplicantBadge-20', 'background-color: ' + _theme2.default.lightGray)
};

var Root = _elem2.default.div(cmz.named('AutoUI_ApplicantBadge-23', /*cmz|*/'\n  display: flex\n  flex-direction: row\n  font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif\n  margin: .5em .5em .5em 0\n' /*|cmz*/));

var Avatar = _elem2.default.img();

var Info = _elem2.default.div(cmz.named('AutoUI_ApplicantBadge-32', '\n  margin: 0 1em\n  padding-top: .5em\n  padding-right: .5em\n  color: ' + _theme2.default.blackHighlight + '\n'));

var Name = _elem2.default.div(cmz.named('AutoUI_ApplicantBadge-39', _typo.family.smallHeading, /*cmz|*/'\n  letter-spacing: -.025em\n  font-size: 1.2em\n  font-weight: normal\n  margin-bottom: .2em\n' /*|cmz*/));

var Email = _elem2.default.div(cmz.named('AutoUI_ApplicantBadge-47', /*cmz|*/'\n  font-size: .9em\n' /*|cmz*/));
...
var option = cmz.named('AutoUI_ApplicantListFilter-8', /*cmz|*/'\n  display: inline-block\n  margin: 5px\n  padding: 5px\n' /*|cmz*/);

var optionContainer = cmz.named('AutoUI_ApplicantListFilter-14', typo.family.base, /*cmz|*/'\n  text-align: right\n' /*|cmz*/);

var label = cmz.named('AutoUI_ApplicantListFilter-20', /*cmz|*/'\n  text-transform: capitalize\n' /*|cmz*/);
...
var _recompose = __webpack_require__(27);
...
var cx = {
  twoColSection: cmz.named('AutoUI_CollapsibleSection-24', /*cmz|*/'display: flex' /*|cmz*/),

  clickable: cmz.named('AutoUI_CollapsibleSection-26', /*cmz|*/'cursor: pointer' /*|cmz*/),

  icon: cmz.named('AutoUI_CollapsibleSection-28', '\n    &::before {\n      content: \'\'\n      position: absolute\n      right: 1rem\n      top: 2.7rem\n      width: 10px\n      height: 0\n      border: 1px solid ' + _theme2.default.red + '\n    }\n\n    &::after {\n      content: \'\'\n      position: absolute\n      right: calc(1rem + 5px)\n      top: calc(2.7rem - 5px)\n      width: 0\n      height: 10px\n      border: 1px solid ' + _theme2.default.red + '\n    }\n  '),

  iconLess: cmz.named('AutoUI_CollapsibleSection-50', /*cmz|*/'\n    &::after {\n      content: none\n    }\n  ' /*|cmz*/)
};

var Root = _elem2.default.section(cmz.named('AutoUI_CollapsibleSection-57', typo.family.base, '\n  & {\n    margin: 0\n    padding: 2rem 1rem\n    font-size: 1rem\n    border-top: 1px solid ' + _theme2.default.lightGrayBorder + '\n    position: relative\n  }\n\n  &:first-child {\n    border: none\n  }\n'));

var Header = _elem2.default.h1(cmz.named('AutoUI_CollapsibleSection-72', typo.family.smallHeading, cx.icon, cx.clickable, '\n  & {\n    letter-spacing: normal\n    text-transform: initial\n    margin: 0\n    line-height: 1.4\n  }\n\n  .' + cx.twoColSection + ' & {\n    width: 200px\n  }\n\n  &:hover {\n    color: ' + _theme2.default.blackHighlight + '\n  }\n'));

var Content = _elem2.default.div(cmz.named('AutoUI_CollapsibleSection-92', '\n  .' + cx.twoColSection + ' & {\n    width: calc(100% - 200px)\n  }\n\n  & > :only-child,\n  & > :nth-child(2) {\n    margin-top: 1em\n  }\n\n  .' + cx.twoColSection + ' & > :only-child,\n  .' + cx.clickable + ' & > :only-child {\n    margin-top: 0\n  }\n'));

var Visible = _elem2.default.div(cmz.named('AutoUI_CollapsibleSection-108', '\n  & {\n    padding-top: 0.5em\n  }\n\n  .' + cx.twoColSection + ' & {\n    padding: 0 5em 0 0\n  }\n\n  & > :first-child {\n    margin-top: 0\n  }\n\n  & > :last-child {\n    margin-bottom: 0\n  }\n'));

var Children = _elem2.default.div(cmz.named('AutoUI_CollapsibleSection-126', '\n  & {\n    padding: 0 5em 0 2em\n  }\n\n  .' + cx.twoColSection + ' & {\n    padding: 0 5em 0 0\n  }\n\n  & > :first-child {\n    margin-top: 0\n  }\n'));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fbjs_lib_shallowEqual__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_change_emitter__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_symbol_observable__ = __webpack_require__(32);
...
var logoWrapper = cmz.named('AutoUI_HeaderBar-11', /*cmz|*/'\n  display: flex\n  justify-content: center\n  box-shadow: 0 0 2px rgba(0, 0, 0, .25)\n  height: 58px\n  padding-top: 28px\n  width: 100%\n' /*|cmz*/);
  ...
  _createClass(HeaderBar, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        (0, _logo.xTeamLogo)(84, 30, '#231f20')
      );
    }
  }]);
...
var Hr = _elem2.default.hr(cmz.named('AutoUI_HorizontalRuler-11', '\n  height: 1px\n  background-color: ' + _theme2.default.lightGrayBorder + '\n  border: 0\n'));
...
var styles = {
  milestones: cmz.named('AutoUI_Milestones-27', /*cmz|*/'\n    margin: 0 auto;\n    padding: 2em 0 3em;\n    list-style: none;\n    position: relative;\n    display: flex;\n    justify-content: space-between;\n  ' /*|cmz*/),

  milestone: cmz.named('AutoUI_Milestones-36', '\n    & {\n      text-align: center;\n      position: relative;\n      width: 100%;\n    }\n\n    &:before {\n      content: \'\';\n      height: .1em;\n      background-color: ' + _theme2.default.offwhite + ';\n      position: absolute;\n      z-index: 1;\n      width: 100%;\n      left: -50%;\n      top: 50%;\n      transform: translateY(-50%);\n      transition: all .25s ease-out;\n    }\n\n    &:after {\n      content: \'\';\n      height: .1em;\n      background-color: ' + _theme2.default.red + ';\n      position: absolute;\n      z-index: 1;\n      width: 0;\n      left: -50%;\n      top: 50%;\n      transform: translateY(-50%);\n      transition: all .25s ease-out;\n    }\n\n    &:first-child:before {\n      display: none;\n    }\n\n    &:first-child:after {\n      display: none;\n    }\n\n    &.isComplete + &.isCurrent:after {\n      width: 100%;\n    }\n\n    &.isComplete + &.isComplete:after {\n      width: 100%;\n    }\n  '),

  icon: cmz.named('AutoUI_Milestones-86', '\n    & {\n      position: relative;\n      display: inline-block;\n      width: 1.2em;\n      height: 1.2em;\n      background-color: ' + _theme2.default.white + ';\n      border: 2px solid ' + _theme2.default.offwhite + ';\n      border-radius: 50%;\n      padding: .5em;\n      max-width: 100%;\n      transition: all .25s ease-out;\n      z-index: 10;\n      cursor: pointer;\n    }\n\n    .isCurrent & {\n      background-color: ' + _theme2.default.red + ';\n      border-color: transparent;\n    }\n\n    .isComplete & {\n      background-color: ' + _theme2.default.white + ';\n      border: 2px solid ' + _theme2.default.red + ';\n    }\n\n    & > svg {\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      transform: translateX(-50%) translateY(-50%);\n      width: 35%;\n      height: 35%;\n    }\n  '),

  label: cmz.named('AutoUI_Milestones-122', typo.family.base, '\n    display: block;\n    text-transform: uppercase;\n    font-size: .8em;\n    font-weight: 400;\n    color: ' + _theme2.default.black + ';\n    position: absolute;\n    padding-top: .2em;\n    width: 100%;\n    transition: all .25s ease-out;\n  ')
};
...
var Milestones = function (_PureComponent) {
  ...
  function Milestones() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Milestones.__proto__ || Object.getPrototypeOf(Milestones)).call.apply(_ref, [this].concat(args))), _this), _this.getCurrentState = function (levelIndex) {
      ...
      return _react2.default.createElement(
        'li',
        { key: index, className: styles.milestone + ' ' + currentState.statusClassName },
        _react2.default.createElement(
          'div',
          { className: styles.icon, onClick: _this.handleChangeMilestone(level, index) },
...
var columnClassName = cmz.named('AutoUI_Roadmap-25', /*cmz|*/'\n  display: flex\n  flex-direction: column\n' /*|cmz*/);

var breakpoints = {
  small: '@media screen and (max-width: 600px)'
};

var Root = _elem2.default.div(cmz.named('AutoUI_Roadmap-34', columnClassName));

var Level = _elem2.default.div(cmz.named('AutoUI_Roadmap-38', columnClassName, '\n    & {\n      position: relative\n      width: 100%\n      margin-top: -' + overlap + 'px\n      min-height: ' + overlap * 2 + 'px\n      padding: 10px 0\n    }\n\n    &:first-child {\n      margin-top: 0\n    }\n\n    &:last-child {\n      align-items: center\n      margin-top: 0\n      padding-top: 80px\n    }\n\n    &:nth-child(even) {\n      align-items: flex-end\n    }\n\n    ' + breakpoints.small + ' {\n      &,\n      &:first-child {\n        margin: 40px 0 0 0\n      }\n\n      &,\n      &:nth-child(even) {\n        align-items: center\n      }\n    }\n  '));

var Box = _elem2.default.div(cmz.named('AutoUI_Roadmap-77', /*cmz|*/'\n  & {\n    width: 45%\n    min-height: 2rem\n    z-index: 2\n  }\n\n  .isFinal & {\n    width: auto\n    padding-left: 6rem\n    padding-right: 6rem\n  }\n' /*|cmz*/));

var Line = _elem2.default.div(cmz.named('AutoUI_Roadmap-91', '\n  & {\n    width: 1px\n    height: auto\n    position: absolute\n    top: 10px\n    bottom: ' + (overlap + 7) + 'px\n    left: 50%\n    margin-left: -8px\n    z-index: 1\n  }\n\n  .isSecondLast & {\n    bottom: 0\n  }\n\n  .isFinal & {\n    top: 17px\n    height: 20px\n  }\n\n  ' + breakpoints.small + ' {\n    & {\n      top: -15px\n      height: calc(100% + 40px)\n    }\n  }\n'));
...
var Root = _elem2.default.div(cmz.named('AutoUI_RoadmapHero-20', '\n  & {\n    display: flex\n    flex-wrap: wrap\n    justify-content: space-around\n    align-items: center\n  }\n\n  @media screen and (max-width: ' + _theme.breakpoints.sm + ') {\n    & {\n      margin: 0 0 35px 0\n    }\n  }\n'));

var HeroHeading = _elem2.default.div(cmz.named('AutoUI_RoadmapHero-35', /*cmz|*/'width: 60%' /*|cmz*/));
...
var RoadmapHero = function (_PureComponent) {
  ...
  function RoadmapHero() {
    ...
    return _possibleConstructorReturn(this, (RoadmapHero.__proto__ || Object.getPrototypeOf(RoadmapHero)).apply(this, arguments));
  }
  ...
  _createClass(RoadmapHero, [{
    ...
    value: function render() {
      ...
      return Root(HeroHeading(_react2.default.createElement(_Text2.default, { heading: heading, content: content, hasDivider: hasDivider })), HeroImage({
        src: imgUrl,
        alt: 'X-Team Roadmap'
      }));
    }
...
module.exports = __webpack_require__.p + "e3bafbf75deef2b697c50a1c4616a476.png";
...
var Root = _elem2.default.section(cmz.named('AutoUI_RoadmapLevel-30', '\n  & {\n    border: 1px solid ' + _theme2.default.lightBorder + ';\n    padding: 2rem;\n  }\n\n  &:first-child {\n    margin-top: 0;\n  }\n\n  &:last-child {\n    margin-bottom: 0;\n  }\n'));

var active = cmz.named('AutoUI_RoadmapLevel-45', 'border: 1px solid ' + _theme2.default.defaultBorder);
var centered = cmz.named('AutoUI_RoadmapLevel-46', /*cmz|*/'\n  text-align: center;\n  border: none;\n' /*|cmz*/);
var ctaButtonStyles = cmz.named('AutoUI_RoadmapLevel-50', /*cmz|*/'margin-top: 3rem' /*|cmz*/);
  ...
  _createClass(RoadmapLevel, [{
    ...
    value: function render() {
      ...
      var buttonCTA = cta.label && _react2.default.createElement(
        _Button2.default,
        { className: ctaButtonStyles, size: 'block', onClick: cta.handle },
        cta.label
      );
...
var cx = {
  footer: cmz.named('AutoUI_Footer_Footer-19', /*cmz|*/'\n    padding: 6.5rem 0;\n  ' /*|cmz*/),
  columnContainer: cmz.named('AutoUI_Footer_Footer-22', /*cmz|*/'\n    display: flex;\n    max-width: 1280px;\n    margin: 0 auto;\n    padding: 0 20px;\n  ' /*|cmz*/),
  logoColumn: cmz.named('AutoUI_Footer_Footer-28', /*cmz|*/'\n    width: 20%;\n  ' /*|cmz*/),
  column: cmz.named('AutoUI_Footer_Footer-31', /*cmz|*/'\n    flex-grow: 1;\n    max-width: 28%;\n  ' /*|cmz*/),
  colophon: cmz.named('AutoUI_Footer_Footer-35', /*cmz|*/'\n    flex-grow: 1;\n    max-width: 72%;\n    margin-top: 3.125rem;\n    padding-top: 2.5rem;\n    border-top: 1px solid rgba(0,0,0,.1)\n  ' /*|cmz*/),
  copyright: cmz.named('AutoUI_Footer_Footer-42', '\n    font-size: 0.75rem;\n    opacity: 0.5;\n    line-height: 0;\n    color: ' + _theme2.default.black + '\n  ', typo.family.base)
};
  ...
  _createClass(Footer, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: cx.columnContainer },
          _react2.default.createElement(
            'div',
            { className: cx.logoColumn },
            (0, _logo.xTeamLogo)(94, 32, '#b3b3b3')
          ),
        ...
        _react2.default.createElement(
          'div',
          { className: cx.columnContainer },
          _react2.default.createElement('div', { className: cx.logoColumn }),
          _react2.default.createElement(
            'div',
...
var cx = {
  logos: cmz.named('AutoUI_Footer_FooterBrands-19', /*cmz|*/'\n    list-style: none;\n    margin: 0;\n    padding: 0;\n    display: flex;\n  ' /*|cmz*/),
  brand: cmz.named('AutoUI_Footer_FooterBrands-25', /*cmz|*/'\n    line-height: 3rem;\n    margin-right: 1rem;\n    display: inline-block;\n    vertical-align: middle;\n  ' /*|cmz*/, '&:last-child { margin-right: 0; }\n  @media screen and (min-width: ' + _theme.breakpoints.md + ') { & {\n    line-height: 4rem;\n    margin-right: 3rem;\n  } }\n  '),
  image: cmz.named('AutoUI_Footer_FooterBrands-37', /*cmz|*/'\n    max-height: 4rem;\n    display: inline-block;\n    vertical-align: middle;\n    max-width: 100%;\n    opacity: 0.8;\n    transition: all .3s ease-in;\n  ' /*|cmz*/),
  brandContainer: cmz.named('AutoUI_Footer_FooterBrands-45', /*cmz|*/'\n    margin: 1.25rem auto;\n  ' /*|cmz*/),
  message: cmz.named('AutoUI_Footer_FooterBrands-48', /*cmz|*/'\n    font-size: .875rem;\n    font-weight: 400;\n    text-transform: uppercase;\n    opacity: .5;\n    margin: 0;\n  ' /*|cmz*/, typo.family.base)
};
...
var cx = {
  link: cmz.named('AutoUI_Footer_FooterList-18', '\n    font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif;\n    font-size: 1rem;\n    color: ' + _theme2.default.black + ';\n    text-decoration: none;\n  '),
  item: cmz.named('AutoUI_Footer_FooterList-24', /*cmz|*/'\n    margin-bottom: .5em;\n  ' /*|cmz*/),
  list: cmz.named('AutoUI_Footer_FooterList-27', /*cmz|*/'\n    list-style: none;\n    margin: 0;\n    padding: 0;\n  ' /*|cmz*/),
  title: cmz.named('AutoUI_Footer_FooterList-32', '\n    font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif;\n    font-size: 1.25rem;\n    text-transform: uppercase;\n    color: ' + _theme2.default.black + '\n    margin: 0 0 2em;\n  ')
};
...
var utilStyles = {
  maxWidth: cmz.named('AutoUI_SolutionForm_index-24', /*cmz|*/'max-width: 740px' /*|cmz*/),
  noOutline: cmz.named('AutoUI_SolutionForm_index-25', /*cmz|*/'outline: none' /*|cmz*/),
  noTextDecoration: cmz.named('AutoUI_SolutionForm_index-26', /*cmz|*/'text-decoration: none' /*|cmz*/)
};

var Root = _elem2.default.div([utilStyles.maxWidth, cmz.named('AutoUI_SolutionForm_index-31', /*cmz|*/'\n    text-align: center\n    min-width: 320px\n    margin: 0px auto\n  ' /*|cmz*/)]);

var Form = _elem2.default.form([utilStyles.maxWidth, cmz.named('AutoUI_SolutionForm_index-40', /*cmz|*/'\n    margin: 30px auto\n    position: relative\n  ' /*|cmz*/)]);

var Textarea = _elem2.default.textarea([utilStyles.noOutline, cmz.named('AutoUI_SolutionForm_index-48', '\n    display: block\n    width: 100%\n    height: 156px\n    resize: none\n    border: ' + _theme2.default.grayBorder + ' solid 3px\n    border-radius: 4px\n    font-size: 28px\n    padding: 10px 20px\n    box-sizing: border-box\n  ')]);

var Button = _elem2.default.button([utilStyles.noOutline, utilStyles.noTextDecoration, cmz.named('AutoUI_SolutionForm_index-64', '\n    & {\n      text-transform: uppercase\n      background: ' + _theme2.default.red + '\n      border: transparent solid 2px\n      border-radius: 3px\n      color: ' + _theme2.default.white + '\n      cursor: pointer\n      font-size: 1rem\n      margin: 0.25em\n      min-width: 290px\n      padding: .75em 2.4em\n      transition: all .3s ease-out\n      font-weight: 700\n    }\n    &:hover {\n      background: ' + _theme2.default.redHighlight + '\n      border-color: transparent\n    }\n    &:active {\n      background: ' + _theme2.default.redHighlight + '\n      transition: none\n    }\n    &[disabled] {\n      background-color: ' + _theme2.default.grayBorder + '\n      pointer-events: none\n    }\n  ')]);
...
var SolutionForm = function (_PureComponent) {
  ...
  _createClass(SolutionForm, [{
    ...
    value: function render() {
      ...
      return Root(_react2.default.createElement(_Title2.default, { hasAttempted: hasAttempted, maxAttempts: maxAttempts }), Form(Textarea({
...
var Root = _elem2.default.div(cmz.named('AutoUI_SolutionForm_Title-17', /*cmz|*/'\n  margin: 0px 0px 35px 0px\n  text-align: center\n' /*|cmz*/));

var Heading = _elem2.default.h1(typo.family.heading);

var Subheading = _elem2.default.h2(cmz.named('AutoUI_SolutionForm_Title-24', /*cmz|*/'\n  margin: 0 0 35px 0\n  font-size: 24px\n' /*|cmz*/));
...
var SolutionFormTitle = function (_PureComponent) {
  ...
  _createClass(SolutionFormTitle, [{
    ...
    value: function render() {
      ...
      return Root(Heading(hasAttempted ? 'Oops!' : 'Got it?'), Subheading(hasAttempted ? 'You haven\u2019t submitted the right solution. Please try again.' : 'Paste the solution below. You get ' + maxAttempts + ' chances.'));
    }
  }]);
