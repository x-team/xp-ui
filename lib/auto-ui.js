...
var cx = {
  container: cmz.named('AutoUI_ApplicantBadge-9', /*cmz|*/'\n    display: flex\n    flex-direction: row\n    font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif\n    margin: .5em .5em .5em 0\n  ' /*|cmz*/),

  isActive: cmz.named('AutoUI_ApplicantBadge-16', 'background-color: ' + _theme2.default.lightGray),

  applicant: cmz.named('AutoUI_ApplicantBadge-18', /*cmz|*/'\n    margin: 0 1em\n    padding-top: .5em\n    padding-right: .5em\n  ' /*|cmz*/)
};
...
var ApplicantBadge = function (_PureComponent) {
  ...
  _createClass(ApplicantBadge, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: cx.container + ' ' + activeClassName },
        ...
        _react2.default.createElement(
          'div',
          { className: cx.applicant + ' ' + activeClassName },
