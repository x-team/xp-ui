...
var labelStyles = cmz.named('AutoUI_forms_InputField-63', _typo2.default.baseText, /*cmz|*/'\n    margin-left: 30px\n  ' /*|cmz*/);
...
var RadioLabel = _elem2.default.label(labelStyles);
...
var checkboxInputStyles = {
  input: cmz.named('AutoUI_forms_InputField-111', '\n    & {\n      display: none !important\n    }\n\n    &:checked ~ span {\n      background-color: ' + _theme2.default.baseRed + '\n    }\n    &:checked ~ span:after {\n      opacity: 1\n    }\n  '),
  tick: cmz.named('AutoUI_forms_InputField-123', '\n    & {\n      cursor: pointer\n      position: absolute\n      width: 18px\n      height: 18px\n      top: 6px\n      left: 0\n      border: 1px solid ' + _theme2.default.formBorder + '\n      border-radius: 4px\n    }\n\n    &:after {\n      opacity: 0\n      content: \' \'\n      position: absolute\n      width: 8px\n      height: 4px\n      top: 5px\n      left: 4px\n      border: 2px solid ' + _theme2.default.baseBrighter + '\n      border-top: none\n      border-right: none\n      transform: rotate(-45deg)\n      transition: all 0.25s ease\n    }\n  ')
};

var CheckboxTick = _elem2.default.span(checkboxInputStyles.tick);
var Checkboxlabel = _elem2.default.label(labelStyles);
...
var isRadioOrCheckbox = function isRadioOrCheckbox(type) {
...
var InputField = function (_PureComponent) {
  ...
  function InputField() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InputField.__proto__ || Object.getPrototypeOf(InputField)).call.apply(_ref, [this].concat(args))), _this), _this.renderField = function () {
      ...
      if (isRadioOrCheckbox(type)) {
        ...
        }, rest)), elements[type].box(), elements[type].label(label));
      }
  ...
  _createClass(InputField, [{
    ...
    value: function render() {
      ...
      var RootComponent = isRadioOrCheckbox(type) ? FieldRoot : ComponentRoot;

      return RootComponent(label ? _react2.default.createElement(
        'label',
        { id: labelId },
        !isRadioOrCheckbox(type) && _react2.default.createElement(_Text2.default, { content: label }),
        this.renderField()
      ) : this.renderField());
    }
  }]);
