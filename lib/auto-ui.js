...
var styles = {
  dropdown: cmz.named('AutoUI_ui_Dropdown-14', _typo2.default.baseText, /*cmz|*/'\n      position: relative\n      display: inline-block\n    ' /*|cmz*/),
  toggler: cmz.named('AutoUI_ui_Dropdown-21', /*cmz|*/'\n    font-weight: 600\n    cursor: pointer\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  label: cmz.named('AutoUI_ui_Dropdown-27', /*cmz|*/'\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  text: cmz.named('AutoUI_ui_Dropdown-31', /*cmz|*/'\n    margin: 0 0 0 6px\n  ' /*|cmz*/),
  triangle: cmz.named('AutoUI_ui_Dropdown-34', /*cmz|*/'\n    transform: translateY(-3px)\n    margin: 0 0 0 7px\n  ' /*|cmz*/),
  content: cmz.named('AutoUI_ui_Dropdown-38', /*cmz|*/'\n    display: none\n    z-index: 999\n  ' /*|cmz*/),
  contentvisible: cmz.named('AutoUI_ui_Dropdown-42', /*cmz|*/'\n    display: block\n    position: absolute\n  ' /*|cmz*/),
  contentright: cmz.named('AutoUI_ui_Dropdown-46', /*cmz|*/'\n    right: 0\n  ' /*|cmz*/)
};
...
var Dropdown = function (_PureComponent) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var childrenClasses = [styles.content, open ? styles.contentvisible : '', position === 'right' ? styles.contentright : ''].join(' ');
      ...
      return children ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: styles.toggler, onClick: this.toggle },
