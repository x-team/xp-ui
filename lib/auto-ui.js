...
var _TruncatedList = __webpack_require__(115);

var _TruncatedList2 = _interopRequireDefault(_TruncatedList);

var _Typography = __webpack_require__(116);
...
var _XIcon = __webpack_require__(118);
...
var styles = {
  ...
  item: cmz.named('AutoUI_ui_TruncatedList-13', /*cmz|*/'\n    display: inline-block\n    padding: 0\n  ' /*|cmz*/),
  hidden: cmz.named('AutoUI_ui_TruncatedList-17', /*cmz|*/'\n    display: none\n  ' /*|cmz*/)
};
...
var TruncatedList = function (_PureComponent) {
  ...
  _createClass(TruncatedList, [{
    ...
    value: function componentDidUpdate(prevProps) {
      ...
      if (!Object.is(prevProps, this.props)) {
        this.setState(function (prevState, props) {
          return _this2.getInitialState(prevState, props);
        });
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var nextIncrement = Number(increment) || itemsLength - realVisible;
      var nextRealIncrement = hiddenItems < nextIncrement || nextIncrement + 1 === hiddenItems ? hiddenItems : nextIncrement;
      var nextView = increment ? realVisible + (page > 1 ? (page - 1) * Number(increment) : 0) : realVisible + nextRealIncrement;

      var renderShowMore = function renderShowMore() {
        return viewMore ? viewMore(nextRealIncrement, _this3.handleViewMore) : _react2.default.createElement(
          'li',
          {
            className: styles.item,
            onClick: _this3.handleViewMore
          },
          increment ? '+' + nextRealIncrement + ' more' : '+' + hiddenItems + ' more'
        );
      };
      ...
      return itemsLength > 0 ? _react2.default.createElement(
        ...
        items.map(function (item, i) {
          var isVisible = allVisible || i < realVisible || increment && i < nextView ? styles.item : [styles.item, styles.hidden].join(' ');
          return _react2.default.createElement(
            'li',
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getInitialState = function (prevState, props) {
  ...
  this.handleViewMore = function () {
    ...
    _this4.setState(function (prevState) {
      return {
        ...
        hiddenItems: increment ? prevState.itemsLength - (inserted ? visible - 1 : visible) - prevState.page * Number(increment) : 0,
