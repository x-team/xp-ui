...
var utilStyles = {
  maxWidth: cmz.named('AutoUI_forms_SolutionForm_index-29', /*cmz|*/'max-width: 840px' /*|cmz*/),
...
var errorTextarea = cmz.named('AutoUI_forms_SolutionForm_index-76', '\n  background: ' + _theme2.default.formErrorShadow + '\n  border-color: ' + _theme2.default.formError + '\n  color: ' + _theme2.default.formError + '\n');
  ...
  _createClass(SolutionFormTitle, [{
    ...
    value: function render() {
      ...
      return Root(_react2.default.createElement(_Text2.default, {
        ...
        content: hasAttempted ? 'You haven\u2019t submitted the right solution. Please try again.' : 'Paste the solution below. You get ' + maxAttempts + ' chances.'
      }));
    }
  }]);
