...
var cardTheme = {
  ...
  controls: cmz.named('AutoUI_ui_ApplicantBadge-107', /*cmz|*/'\n    grid-area: control\n    display: flex\n    visibility: hidden\n  ' /*|cmz*/),

  displayControlsOnHover: cmz.named('AutoUI_ui_ApplicantBadge-113', /*cmz|*/'\n    &:hover #dropdown-controls {\n      visibility: visible\n    }\n  ' /*|cmz*/),

  infos: cmz.named('AutoUI_ui_ApplicantBadge-119', /*cmz|*/'\n    grid-area: infos\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: flex-start\n    margin: 0 0 -10px\n  ' /*|cmz*/),

  info: cmz.named('AutoUI_ui_ApplicantBadge-128', _typo2.default.baseText, /*cmz|*/'\n      & {\n        margin: 0 20px 10px 0\n      }\n\n      &:last-of-type {\n        margin-right: 0\n      }\n    ' /*|cmz*/),

  moreinfos: cmz.named('AutoUI_ui_ApplicantBadge-140', '\n    & {\n      color: ' + _theme2.default.typoLabel + '\n      font-size: 17px\n      margin: 0 0 10px 0\n      cursor: pointer\n      align-self: flex-end\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),

  label: cmz.named('AutoUI_ui_ApplicantBadge-154', '\n    display: block\n    color: ' + _theme2.default.typoLabel + '\n    white-space: nowrap\n    line-height: 1.2\n    font-size: 17px\n  '),

  value: cmz.named('AutoUI_ui_ApplicantBadge-162', '\n    display: block\n    color: ' + _theme2.default.typoParagraph + '\n    line-height: 1.2\n    font-size: 17px\n    white-space: normal\n  '),

  tip: cmz.named('AutoUI_ui_ApplicantBadge-170', '\n    font-size: 15px\n    color: ' + _theme2.default.typoParagraph + '\n    line-height: 1.4\n  '),

  tags: cmz.named('AutoUI_ui_ApplicantBadge-176', /*cmz|*/'\n    font-size: 14px\n    grid-area: tags\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: start\n    margin: 0 0 -10px\n  ' /*|cmz*/),

  tag: cmz.named('AutoUI_ui_ApplicantBadge-186', '\n    & {\n      border: 1px solid ' + _theme2.default.lineSilver2 + '\n      border-radius: 3px\n      padding: 0 10px\n      text-transform: uppercase\n      margin: 0 10px 10px 0\n      white-space: nowrap\n      color: ' + _theme2.default.typoParagraph + '\n    }\n\n    &:last-of-type {\n      margin-right: 0\n    }\n  '),

  moretags: cmz.named('AutoUI_ui_ApplicantBadge-202', '\n    & {\n      border: none\n      padding: 0 0 0 20px\n      text-transform: initial\n      margin: 0 0 10px 0\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),

  purelabel: cmz.named('AutoUI_ui_ApplicantBadge-216', '\n    border: none\n    color: ' + _theme2.default.typoLabel + '\n    font-size: 17px\n  '),

  children: cmz.named('AutoUI_ui_ApplicantBadge-222', /*cmz|*/'\n    grid-column: 1 / -1\n    grid-row: 4 / -1\n  ' /*|cmz*/)
};
