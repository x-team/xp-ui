...
var FilesList = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-33', /*cmz|*/'\n  margin-bottom: 30px\n' /*|cmz*/));

var FileItem = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-37', '\n  position: relative\n  display: flex\n  align-items: start\n  height: 20px\n  margin-bottom: 20px\n  border-bottom: 2px solid ' + _theme2.default.baseSilver + '\n'));

var FileName = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-46', _typo2.default.baseText, /*cmz|*/'\n    width: 100%\n    font-size: 16px\n    line-height: 1\n  ' /*|cmz*/));

var FileAction = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-55', /*cmz|*/'\n  cursor: pointer\n' /*|cmz*/));

var FileProgress = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-59', '\n  position: absolute\n  bottom: -2px\n  display: block\n  height: 2px\n  width: 0\n  background-color: ' + _theme2.default.baseRed + '\n  transition: width 0.5s\n'));

var ButtonLabel = _elem2.default.span(cmz.named('AutoUI_ui_AttachFiles-69', /*cmz|*/'\n  padding: 0 20px\n' /*|cmz*/));

var HiddenInput = _elem2.default.input(cmz.named('AutoUI_ui_AttachFiles-73', /*cmz|*/'\n  width: 0.1px\n  height: 0.1px\n  opacity: 0\n  overflow: hidden\n  position: absolute\n  zIndex: -1\n' /*|cmz*/));
...
var AttachFiles = function (_PureComponent) {
  ...
  _createClass(AttachFiles, [{
    ...
    value: function render() {
      ...
      var ACCEPTED_FILE_TYPES = ['application/pdf', 'application/zip', 'application/x-rar-compressed', 'image/gif', 'image/jpeg', 'image/png', 'video/*'].join(',');
