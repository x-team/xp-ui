...
var cardTheme = {
  ...
  controls: cmz.named('AutoUI_ui_ApplicantBadge-85', /*cmz|*/'\n    grid-area: control\n    display: flex\n  ' /*|cmz*/),

  control: cmz.named('AutoUI_ui_ApplicantBadge-90', '\n    & {\n      display: inline-block\n      padding: 0\n      margin: 0 0 0 5px\n      border: 0\n      border-radius: 2px\n      cursor: pointer\n      width: 20px\n      height: 20px\n      text-align: center\n      line-height: 1\n    }\n\n    &:hover {\n      background: ' + _theme2.default.baseRed + '\n    }\n\n    &:hover svg g,\n    &:hover svg polyline {\n      stroke: white\n    }\n  '),

  infos: cmz.named('AutoUI_ui_ApplicantBadge-114', /*cmz|*/'\n    grid-area: infos\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: flex-start\n    margin: 0 0 -10px\n  ' /*|cmz*/),

  info: cmz.named('AutoUI_ui_ApplicantBadge-123', _typo2.default.baseText, /*cmz|*/'\n      & {\n        margin: 0 20px 10px 0\n      }\n\n      &:last-of-type {\n        margin-right: 0\n      }\n    ' /*|cmz*/),

  moreinfos: cmz.named('AutoUI_ui_ApplicantBadge-135', '\n    & {\n      color: ' + _theme2.default.typoLabel + '\n      font-size: 17px\n      margin: 0 0 10px 0\n      flex: 1\n      cursor: pointer\n      align-self: flex-end\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),

  label: cmz.named('AutoUI_ui_ApplicantBadge-150', '\n    display: block\n    color: ' + _theme2.default.typoLabel + '\n    white-space: nowrap\n    line-height: 1.2\n    font-size: 17px\n  '),

  value: cmz.named('AutoUI_ui_ApplicantBadge-158', '\n    display: block\n    color: ' + _theme2.default.typoParagraph + '\n    line-height: 1.2\n    font-size: 17px\n    white-space: normal\n  '),
