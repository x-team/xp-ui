...
var _webfontloader = __webpack_require__(47);
...
var _reactClickOutside = __webpack_require__(63);
...
var _CollapsibleSection = __webpack_require__(52);

var _CollapsibleSection2 = _interopRequireDefault(_CollapsibleSection);

var _ColorPalette = __webpack_require__(62);
...
var _HeaderBar = __webpack_require__(20);
...
var _InputField = __webpack_require__(15);
...
var cardTheme = {
  mode: cmz.named('AutoUI_ui_ApplicantBadge-36', _typo2.default.baseText, '\n      border: 1px solid ' + _theme2.default.lineSilver2 + '\n      padding: 30px\n      display: grid\n      grid-template: \'avatar name name control\' \'avatar infos infos infos\' \'tags tags tags tags\'\n      grid-template-columns: 90px 2fr 1fr\n      grid-template-rows: minmax(20px, auto) auto auto\n      grid-gap: 20px\n      margin: 0 10px\n    '),
  active: cmz.named('AutoUI_ui_ApplicantBadge-49', '\n    border: 1px solid ' + _theme2.default.baseRed + '\n    box-shadow: 0 3px 8px rgba(0, 0, 0, 0.15)\n    margin: 0\n  '),
  name: cmz.named('AutoUI_ui_ApplicantBadge-54', _typo2.default.badgeHeading, /*cmz|*/'\n      grid-area: name\n      display: flex\n      align-items: flex-end\n    ' /*|cmz*/),
  avatar: cmz.named('AutoUI_ui_ApplicantBadge-61', /*cmz|*/'\n    grid-area: avatar\n    width: 90px\n    height: 90px\n  ' /*|cmz*/),
  controls: cmz.named('AutoUI_ui_ApplicantBadge-66', /*cmz|*/'\n    grid-area: control\n    display: flex\n    visibility: hidden\n    opacity: 0\n    transition: visibility 0s linear 0.2s, opacity 0.2s linear\n  ' /*|cmz*/),
  control: cmz.named('AutoUI_ui_ApplicantBadge-73', '\n    & {\n      display: inline-block\n      padding: 0\n      margin: 0 0 0 5px\n      border: 0\n      border-radius: 2px\n      cursor: pointer\n      width: 20px\n      height: 20px\n      text-align: center\n      line-height: 1\n    }\n\n    &:hover {\n      background: ' + _theme2.default.baseRed + '\n    }\n\n    &:hover svg g,\n    &:hover svg polyline {\n      stroke: white\n    }\n  '),
  infos: cmz.named('AutoUI_ui_ApplicantBadge-96', /*cmz|*/'\n    grid-area: infos\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: flex-end\n    margin: 0 0 -10px\n  ' /*|cmz*/),
  info: cmz.named('AutoUI_ui_ApplicantBadge-104', _typo2.default.baseText, /*cmz|*/'\n      margin: 0 40px 10px 0\n      white-space: nowrap\n    ' /*|cmz*/),
  moreinfos: cmz.named('AutoUI_ui_ApplicantBadge-110', '\n    & {\n      font-size: 14px\n      margin: 0 0 10px 0\n      flex: 1\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),
  label: cmz.named('AutoUI_ui_ApplicantBadge-122', '\n    display: block\n    color: ' + _theme2.default.typoLabel + '\n  '),
  value: cmz.named('AutoUI_ui_ApplicantBadge-126', '\n    display: block\n    color: ' + _theme2.default.typoParagraph + '\n  '),
  tags: cmz.named('AutoUI_ui_ApplicantBadge-130', /*cmz|*/'\n    font-size: 14px\n    grid-area: tags\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: start\n    margin: 0 0 -10px\n  ' /*|cmz*/),
  tag: cmz.named('AutoUI_ui_ApplicantBadge-139', '\n    border: 1px solid ' + _theme2.default.lineSilver2 + '\n    border-radius: 3px\n    padding: 0 10px\n    text-transform: uppercase\n    margin: 0 10px 10px 0\n    white-space: nowrap\n    color: ' + _theme2.default.typoParagraph + '\n  '),
  moretags: cmz.named('AutoUI_ui_ApplicantBadge-148', '\n    & {\n      border: none\n      padding: 0 0 0 20px\n      text-transform: initial\n      margin: 0 0 10px 0\n      flex: 1\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),
  children: cmz.named('AutoUI_ui_ApplicantBadge-162', /*cmz|*/'\n    grid-column: 2 / -1;\n    grid-row: 2 / -1;\n  ' /*|cmz*/)
};

cardTheme.displayControlsOnHover = cmz.named('AutoUI_ui_ApplicantBadge-168', '\n  &:hover .' + cardTheme.controls + ' {\n    visibility: visible\n    opacity: 1\n    transition-delay: 0s\n  }\n');

var tabularTheme = {}; // to do: https://zube.io/x-team/xp-formerly-auto/c/1638
    ...
    value: function render() {
      ...
      var mapInfosToRender = function mapInfosToRender(infos) {
        return _react2.default.createElement(_TruncatedList2.default, {
          ...
          listClass: cx.infos,
          itemClass: cx.info,
          items: infos && info.map(function (info, i) {
            return _react2.default.createElement(
              'span',
              { key: i },
              _react2.default.createElement(
      ...
      var mapTagsToRender = function mapTagsToRender(tags) {
        return _react2.default.createElement(_TruncatedList2.default, {
          ...
          viewMore: function viewMore(amount, action) {
            return _react2.default.createElement(
              'li',
              { className: [cx.tag, cx.moretags].join(' '), onClick: action },
              '+' + amount + ' more'
            );
          }
        });
      ...
      return id ? _react2.default.createElement(
        ...
        (name || email) && _react2.default.createElement(
          'div',
          { onClick: handleClick, className: cx.name },
          name || email
        ),
        (avatar || email) && _react2.default.createElement(
          'div',
          { onClick: handleClick, className: cx.avatar },
        ...
        onExclude && _react2.default.createElement(
          'div',
          { className: cx.controls },
          _react2.default.createElement(
            'span',
            { onClick: handleExclude, className: cx.control },
...
var cardTheme = {
  ...
  more: cmz.named('AutoUI_ui_ApplicantGrid-15', /*cmz|*/'\n    & button {\n      margin: 10px\n      width: calc(100% - 20px)\n    }\n  ' /*|cmz*/)
};
...
var ApplicantGrid = function (_PureComponent) {
  ...
  function ApplicantGrid() {
    ...
    return _possibleConstructorReturn(this, (ApplicantGrid.__proto__ || Object.getPrototypeOf(ApplicantGrid)).apply(this, arguments));
  }
      ...
      return items ? _react2.default.createElement(_TruncatedList2.default, {
        ...
        viewMore: function viewMore(amount, action) {
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              _Button2.default,
              { onClick: action, outlined: true, block: true },
              'View more'
            )
          );
        }
...
var _recompose = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fbjs_lib_shallowEqual__ = __webpack_require__(54);
