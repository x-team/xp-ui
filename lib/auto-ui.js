...
var styles = {
  ...
  editing: cmz.named('AutoUI_ui_SelectBox-194', '\n    & input {\n      border-bottom: 1px solid ' + _theme2.default.baseRed + ' !important\n    }\n  '),
  control: cmz.named('AutoUI_ui_SelectBox-199', /*cmz|*/'\n    flex-shrink: 0\n    display: flex\n  ' /*|cmz*/),
  controlbutton: cmz.named('AutoUI_ui_SelectBox-203', /*cmz|*/'\n    cursor: pointer\n    padding: 5px\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  editButton: cmz.named('AutoUI_ui_SelectBox-209', 'editButton', /*cmz|*/'\n    display: none\n  ' /*|cmz*/),
  selecting: cmz.named('AutoUI_ui_SelectBox-212', _typo2.default.baseText, /*cmz|*/'\n      padding: 0 0 0 30px\n      position: relative\n    ' /*|cmz*/),
  selectingdots: cmz.named('AutoUI_ui_SelectBox-219', '\n    & {\n      position: absolute\n      top: calc(50% - 9px)\n      left: 0\n      width: 20px\n      height: 20px\n      border-top-color: ' + _theme2.default.lineSilver2 + '\n      border-left-color: ' + _theme2.default.lineSilver2 + '\n      animation: spinner 400ms linear infinite\n      border-bottom-color: transparent\n      border-right-color: transparent\n      border-style: solid\n      border-width: 2px\n      border-radius: 50%\n      box-sizing: border-box\n      display: inline-block\n      vertical-align: middle\n    }\n\n    @keyframes spinner {\n      0% {\n        transform: rotate(0deg)\n      }\n      100% {\n        transform: rotate(360deg)\n      }\n    }\n  '),
  // !important is used to override global input values
  editinput: cmz.named('AutoUI_ui_SelectBox-249', _typo2.default.baseText, /*cmz|*/'\n      & {\n        width: 70%\n        height: 30px\n      }\n\n      & input {\n        height: 30px !important\n        padding: 0 !important\n        border-top: none !important\n        border-right: none !important\n        border-left: none !important\n        transition: all .2s ease\n      }\n    ' /*|cmz*/),
  nothinglabel: cmz.named('AutoUI_ui_SelectBox-267', _typo2.default.baseText, /*cmz|*/'\n      display: block\n      margin: 15px 22px\n    ' /*|cmz*/),
  createnew: cmz.named('AutoUI_ui_SelectBox-274', _typo2.default.baseText, '\n      & {\n        display: flex\n        align-items: center\n        margin: 15px 22px\n        color: ' + _theme2.default.baseRed + '\n        cursor: pointer\n      }\n\n      & svg {\n        transform: scale(0.7)\n        margin-right: 8px\n      }\n    '),
  appendix: cmz.named('AutoUI_ui_SelectBox-291', '\n    border-right: 1px solid ' + _theme2.default.lineSilver2 + '\n    border-left: 1px solid ' + _theme2.default.lineSilver2 + '\n  ')
};
