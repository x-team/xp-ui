...
var animatedStyles = {
  ...
  checkmarkActive: cmz.named('AutoUI_ui_RoadmapTimelineElement-77', '\n    & {\n      box-shadow: inset 0 0 0 8px ' + _theme2.default.baseRed + '\n    }\n  '),
  checkmarkCheck: cmz.named('AutoUI_ui_RoadmapTimelineElement-82', /*cmz|*/'\n    transform-origin: 50% 50%\n    opacity: 0\n    transition: opacity .2s\n  ' /*|cmz*/),
  checkmarkCheckActive: cmz.named('AutoUI_ui_RoadmapTimelineElement-87', /*cmz|*/'\n    opacity: 1\n  ' /*|cmz*/)
};
