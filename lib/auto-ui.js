...
var styles = {
  ...
  selectsEmpty: cmz.named('AutoUI_ui_SelectBox-63', /*cmz|*/'\n    & > div:first-of-type {\n      transition: color 0.15s ease-out, font-size 0.15s ease-out\n    }\n\n    & > div:last-of-type {\n      transition: visibility 1s, opacity 0.15s ease-out, padding 0.15s ease-out\n      visibility: hidden\n      opacity: 0\n    }\n  ' /*|cmz*/),
  search: cmz.named('AutoUI_ui_SelectBox-74', /*cmz|*/'\n    position: relative\n  ' /*|cmz*/),
  // The !important used below is required to override the global input[type="text"] styles
  searchinput: cmz.named('AutoUI_ui_SelectBox-78', /*cmz|*/'\n    padding: 23px 30px 20px 52px !important\n    height: 60px !important\n    width: 100%\n  ' /*|cmz*/),
  magnifier: cmz.named('AutoUI_ui_SelectBox-83', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: 23px\n      left: 22px\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  triangle: cmz.named('AutoUI_ui_SelectBox-95', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: 50%\n      right: 30px\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  close: cmz.named('AutoUI_ui_SelectBox-107', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: calc(50% - 7px)\n      right: 40px\n      cursor: pointer\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  label: cmz.named('AutoUI_ui_SelectBox-120', _typo2.default.baseText, /*cmz|*/'\n      line-height: 1\n    ' /*|cmz*/),
  labelevent: cmz.named('AutoUI_ui_SelectBox-126', _typo2.default.baseText, /*cmz|*/'\n      line-height: 1\n      font-style: italic\n    ' /*|cmz*/),
  list: cmz.named('AutoUI_ui_SelectBox-133', '\n    list-style: none\n    margin: 0\n    padding: 0\n    border: 1px solid ' + _theme2.default.lineSilver2 + '\n    border-top: none\n    overflow-y: scroll\n    background: ' + _theme2.default.baseBrighter + '\n    width: 100%\n    box-sizing: border-box\n  '),
  shadow: cmz.named('AutoUI_ui_SelectBox-144', /*cmz|*/'\n    box-shadow: 0 5px 12px rgba(0, 0, 0, 0.15)\n  ' /*|cmz*/),
  item: cmz.named('AutoUI_ui_SelectBox-147', /*cmz|*/'\n    & {\n      min-height: 30px\n      margin: 22px\n      display: flex\n      justify-content: space-between\n      align-items: center\n    }\n\n    &:last-child {\n      border-bottom: none\n    }\n  ' /*|cmz*/),
  lined: cmz.named('AutoUI_ui_SelectBox-160', '\n    border-bottom: 1px solid ' + _theme2.default.lineSilver2 + '\n    margin: 0 22px\n    padding: 15px 0\n  '),
  editing: cmz.named('AutoUI_ui_SelectBox-165', '\n    & input {\n      border-bottom: 1px solid ' + _theme2.default.baseRed + '\n    }\n  '),
  control: cmz.named('AutoUI_ui_SelectBox-170', /*cmz|*/'\n    flex-shrink: 0\n    display: flex\n  ' /*|cmz*/),
  controlbutton: cmz.named('AutoUI_ui_SelectBox-174', /*cmz|*/'\n    cursor: pointer\n    padding: 5px\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  saving: cmz.named('AutoUI_ui_SelectBox-180', _typo2.default.baseText),
  selecting: cmz.named('AutoUI_ui_SelectBox-181', _typo2.default.baseText, /*cmz|*/'\n      padding: 0 0 0 30px\n      position: relative\n    ' /*|cmz*/),
  selectingdots: cmz.named('AutoUI_ui_SelectBox-188', '\n    & {\n      position: absolute\n      top: calc(50% - 9px)\n      left: 0\n      width: 20px\n      height: 20px\n      border-top-color: ' + _theme2.default.lineSilver2 + '\n      border-left-color: ' + _theme2.default.lineSilver2 + '\n      animation: spinner 400ms linear infinite\n      border-bottom-color: transparent\n      border-right-color: transparent\n      border-style: solid\n      border-width: 2px\n      border-radius: 50%\n      box-sizing: border-box\n      display: inline-block\n      vertical-align: middle\n    }\n\n    @keyframes spinner {\n      0% {\n        transform: rotate(0deg)\n      }\n      100% {\n        transform: rotate(360deg)\n      }\n    }\n  '),
  editinput: cmz.named('AutoUI_ui_SelectBox-217', _typo2.default.baseText, /*cmz|*/'\n      & {\n        width: 70%\n        height: 30px\n      }\n\n      & input {\n        height: 30px\n        padding: 0\n        border-top: none\n        border-right: none\n        border-left: none\n      }\n    ' /*|cmz*/),
  nothinglabel: cmz.named('AutoUI_ui_SelectBox-234', _typo2.default.baseText, /*cmz|*/'\n      display: block\n      margin: 15px 22px\n    ' /*|cmz*/),
  createnew: cmz.named('AutoUI_ui_SelectBox-241', _typo2.default.baseText, '\n      & {\n        display: flex\n        align-items: center\n        margin: 15px 22px\n        color: ' + _theme2.default.baseRed + '\n        cursor: pointer\n      }\n\n      & svg {\n        transform: scale(0.7)\n        margin-right: 8px\n      }\n    ')
};
