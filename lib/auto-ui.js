...
var styles = {
  ...
  shadow: cmz.named('AutoUI_ui_SelectBox-147', /*cmz|*/'\n    box-shadow: 0 5px 12px rgba(0, 0, 0, 0.15)\n  ' /*|cmz*/),
  item: cmz.named('AutoUI_ui_SelectBox-150', _typo2.default.baseText, '\n    & {\n      min-height: 30px\n      padding: 15px 22px\n      display: flex\n      justify-content: space-between\n      align-items: center\n    }\n\n    &:hover {\n      background-color: ' + _theme2.default.baseBright + '\n    }\n\n    &:last-child::after {\n      background-color: transparent\n    }\n\n    &:not(.isSaving):not(.isSelecting):hover .editButton {\n      display: flex\n    }\n  '),
  lined: cmz.named('AutoUI_ui_SelectBox-171', '\n    & {\n      position: relative\n    }\n\n    &::after {\n      content: \'\'\n      display: block\n      height: 1px\n      width: calc(100% - 30px)\n      position: absolute\n      bottom: 0\n      left: 15px\n      background-color: ' + _theme2.default.lineSilver2 + '\n    }\n  '),
  editing: cmz.named('AutoUI_ui_SelectBox-187', '\n    & input {\n      border-bottom: 1px solid ' + _theme2.default.baseRed + '\n    }\n  '),
  control: cmz.named('AutoUI_ui_SelectBox-192', /*cmz|*/'\n    flex-shrink: 0\n    display: flex\n  ' /*|cmz*/),
  controlbutton: cmz.named('AutoUI_ui_SelectBox-196', /*cmz|*/'\n    cursor: pointer\n    padding: 5px\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  editButton: cmz.named('AutoUI_ui_SelectBox-202', 'editButton', /*cmz|*/'\n    display: none\n  ' /*|cmz*/),
  selecting: cmz.named('AutoUI_ui_SelectBox-205', _typo2.default.baseText, /*cmz|*/'\n      padding: 0 0 0 30px\n      position: relative\n    ' /*|cmz*/),
  selectingdots: cmz.named('AutoUI_ui_SelectBox-212', '\n    & {\n      position: absolute\n      top: calc(50% - 9px)\n      left: 0\n      width: 20px\n      height: 20px\n      border-top-color: ' + _theme2.default.lineSilver2 + '\n      border-left-color: ' + _theme2.default.lineSilver2 + '\n      animation: spinner 400ms linear infinite\n      border-bottom-color: transparent\n      border-right-color: transparent\n      border-style: solid\n      border-width: 2px\n      border-radius: 50%\n      box-sizing: border-box\n      display: inline-block\n      vertical-align: middle\n    }\n\n    @keyframes spinner {\n      0% {\n        transform: rotate(0deg)\n      }\n      100% {\n        transform: rotate(360deg)\n      }\n    }\n  '),
  editinput: cmz.named('AutoUI_ui_SelectBox-241', _typo2.default.baseText, /*cmz|*/'\n      & {\n        width: 70%\n        height: 30px\n      }\n\n      & input {\n        height: 30px\n        padding: 0\n        border-top: none\n        border-right: none\n        border-left: none\n      }\n    ' /*|cmz*/),
  nothinglabel: cmz.named('AutoUI_ui_SelectBox-258', _typo2.default.baseText, /*cmz|*/'\n      display: block\n      margin: 15px 22px\n    ' /*|cmz*/),
  createnew: cmz.named('AutoUI_ui_SelectBox-265', _typo2.default.baseText, '\n      & {\n        display: flex\n        align-items: center\n        margin: 15px 22px\n        color: ' + _theme2.default.baseRed + '\n        cursor: pointer\n      }\n\n      & svg {\n        transform: scale(0.7)\n        margin-right: 8px\n      }\n    '),
  appendix: cmz.named('AutoUI_ui_SelectBox-282', '\n    border-right: 1px solid ' + _theme2.default.lineSilver2 + '\n    border-left: 1px solid ' + _theme2.default.lineSilver2 + '\n  ')
};
  ...
  _createClass(SelectBox, [{
    ...
    value: function render() {
      ...
      var renderItems = function renderItems() {
        return filteredItems && filteredItems.length > 0 || creating || search ? _react2.default.createElement(
          'ul',
          { className: styles.list, style: {
              maxHeight: visibleItems ? visibleItems * 60 + 'px' : 'auto',
              width: width ? width + 'px' : '100%'
            } },
          filteredItems && filteredItems.length === 0 && _react2.default.createElement(
            'li',
            null,
...
var cx = {
  listseditor: cmz.named('AutoUI_ui_ListsEditor-15', /*cmz|*/'\n    width: 500px\n    max-width: 100%\n  ' /*|cmz*/)
};

var ListsEditor = function (_PureComponent) {
  _inherits(ListsEditor, _PureComponent);

  function ListsEditor() {
    _classCallCheck(this, ListsEditor);

    return _possibleConstructorReturn(this, (ListsEditor.__proto__ || Object.getPrototypeOf(ListsEditor)).apply(this, arguments));
  }
