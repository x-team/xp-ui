...
var styles = {
  ...
  label: cmz.named('AutoUI_ui_Milestones-128', _typo2.default.labelText, '\n      display: block\n      color: ' + _theme2.default.typoHeading + '\n      position: absolute\n      padding-top: .5em\n      width: 100%\n      transition: all .25s ease-out\n    ')
};
...
var Content = _elem2.default.div(cmz.named('AutoUI_ui_ApplicantScreen-16', /*cmz|*/'\n  max-width: 1280px\n  margin: 93px auto 0\n' /*|cmz*/));
...
var Wrapper = _elem2.default.div(cmz.named('AutoUI_ui_MilestonesScreen-19', /*cmz|*/'\n  max-width: 840px\n  margin: 0 auto\n  padding-left: 60px\n  padding-right: 60px\n' /*|cmz*/));

var Content = _elem2.default.div(cmz.named('AutoUI_ui_MilestonesScreen-26', /*cmz|*/'\n  & > *:only-child,\n  & > *:first-child {\n    border-top: none\n  }\n\n  & > *:only-child,\n  & > *:last-child {\n    padding-bottom: 27px\n  }\n' /*|cmz*/));

var Block = _elem2.default.div(cmz.named('AutoUI_ui_MilestonesScreen-38', '\n  padding: 80px 0 84px\n  border-top: 1px solid ' + _theme2.default.lineSilver2 + '\n'));
...
var MilestonesScreen = function (_PureComponent) {
  ...
  _createClass(MilestonesScreen, [{
    ...
    value: function render() {
      ...
      return Root(milestones, Wrapper(Content(childBlocks), CTA(cta)));
    }
  }]);
