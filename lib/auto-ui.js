...
var cardTheme = {
  mode: cmz.named('AutoUI_ui_ApplicantBadge-38', _typo2.default.baseText, '\n      & {\n        transition: all 0.4s ease-out\n        background: ' + _theme2.default.baseBrighter + '\n        border: 1px solid ' + _theme2.default.lineSilver2 + '\n        padding: 30px\n        display: grid\n        grid-template: \'avatar name control\' \'avatar infos infos\' \'tags tags tags\'\n        grid-template-columns: 90px 1fr auto\n        grid-template-rows: minmax(20px, auto) auto auto\n        grid-gap: 15px\n        margin: 0 10px\n        cursor: pointer\n      }\n\n      &:hover {\n        box-shadow: 0 1px 8px rgba(0, 0, 0, 0.2)\n      }\n    '),

  active: cmz.named('AutoUI_ui_ApplicantBadge-61', '\n    transition: all 0.2s ease-in\n    border: 1px solid ' + _theme2.default.baseRed + '\n    box-shadow: 0 1px 8px rgba(0, 0, 0, 0.2)\n    margin: 0\n    padding: 30px 40px\n  '),

  name: cmz.named('AutoUI_ui_ApplicantBadge-69', _typo2.default.badgeHeading, /*cmz|*/'\n      grid-area: name\n      display: flex\n      align-items: flex-end\n      font-size: 17px\n    ' /*|cmz*/),

  avatar: cmz.named('AutoUI_ui_ApplicantBadge-78', /*cmz|*/'\n    grid-area: avatar\n    width: 90px\n    height: 90px\n  ' /*|cmz*/),

  control: cmz.named('AutoUI_ui_ApplicantBadge-84', '\n    & {\n      display: inline-block\n      padding: 0\n      margin: 0 0 0 5px\n      border: 0\n      border-radius: 2px\n      cursor: pointer\n      width: 20px\n      height: 20px\n      text-align: center\n      line-height: 1\n    }\n\n    &:hover {\n      background: ' + _theme2.default.baseRed + '\n    }\n\n    &:hover svg g,\n    &:hover svg polyline {\n      stroke: white\n    }\n  '),

  controls: cmz.named('AutoUI_ui_ApplicantBadge-108', /*cmz|*/'\n    grid-area: control\n    display: flex\n    visibility: hidden\n  ' /*|cmz*/),

  displayControlsOnHover: cmz.named('AutoUI_ui_ApplicantBadge-114', /*cmz|*/'\n    &:hover #dropdown-controls {\n      visibility: visible\n    }\n  ' /*|cmz*/),

  infos: cmz.named('AutoUI_ui_ApplicantBadge-120', /*cmz|*/'\n    grid-area: infos\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: flex-start\n    margin: 0 0 -10px\n  ' /*|cmz*/),

  info: cmz.named('AutoUI_ui_ApplicantBadge-129', _typo2.default.baseText, /*cmz|*/'\n      & {\n        margin: 0 20px 10px 0\n      }\n\n      &:last-of-type {\n        margin-right: 0\n      }\n    ' /*|cmz*/),

  moreinfos: cmz.named('AutoUI_ui_ApplicantBadge-141', '\n    & {\n      color: ' + _theme2.default.typoLabel + '\n      font-size: 17px\n      margin: 0 0 10px 0\n      cursor: pointer\n      align-self: flex-end\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),

  label: cmz.named('AutoUI_ui_ApplicantBadge-155', '\n    display: block\n    color: ' + _theme2.default.typoLabel + '\n    white-space: nowrap\n    line-height: 1.2\n    font-size: 17px\n  '),

  value: cmz.named('AutoUI_ui_ApplicantBadge-163', '\n    display: block\n    color: ' + _theme2.default.typoParagraph + '\n    line-height: 1.2\n    font-size: 17px\n    white-space: normal\n  '),

  tip: cmz.named('AutoUI_ui_ApplicantBadge-171', '\n    font-size: 15px\n    color: ' + _theme2.default.typoParagraph + '\n    line-height: 1.4\n  '),

  tags: cmz.named('AutoUI_ui_ApplicantBadge-177', /*cmz|*/'\n    font-size: 14px\n    grid-area: tags\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: start\n    margin: 0 0 -10px\n  ' /*|cmz*/),

  tag: cmz.named('AutoUI_ui_ApplicantBadge-187', '\n    & {\n      border: 1px solid ' + _theme2.default.lineSilver2 + '\n      border-radius: 3px\n      padding: 0 10px\n      text-transform: uppercase\n      margin: 0 10px 10px 0\n      white-space: nowrap\n      color: ' + _theme2.default.typoParagraph + '\n    }\n\n    &:last-of-type {\n      margin-right: 0\n    }\n  '),

  moretags: cmz.named('AutoUI_ui_ApplicantBadge-203', '\n    & {\n      border: none\n      padding: 0 0 0 20px\n      text-transform: initial\n      margin: 0 0 10px 0\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),

  purelabel: cmz.named('AutoUI_ui_ApplicantBadge-217', '\n    border: none\n    color: ' + _theme2.default.typoLabel + '\n    font-size: 17px\n  '),

  children: cmz.named('AutoUI_ui_ApplicantBadge-223', /*cmz|*/'\n    grid-column: 1 / -1\n    grid-row: 4 / -1\n  ' /*|cmz*/)
};
  ...
  _createClass(ApplicantBadge, [{
    ...
    value: function render() {
      ...
      return id ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { id: 'dropdown-controls', className: cx.controls },
          renderApprovalDropdown && _react2.default.createElement(
            _Dropdown2.default,
            {
              tooltip: true,
              label: _react2.default.createElement(
          ...
          renderExclusionDropdown && _react2.default.createElement(
            _Dropdown2.default,
            {
              tooltip: true,
              label: _react2.default.createElement(
