...
var utilStyles = {
  maxWidth: cmz.named('AutoUI_SolutionForm_index-25', /*cmz|*/'max-width: 740px' /*|cmz*/),
  noOutline: cmz.named('AutoUI_SolutionForm_index-26', /*cmz|*/'outline: none' /*|cmz*/),
  noTextDecoration: cmz.named('AutoUI_SolutionForm_index-27', /*cmz|*/'text-decoration: none' /*|cmz*/)
};

var Root = _elem2.default.div([utilStyles.maxWidth, cmz.named('AutoUI_SolutionForm_index-32', /*cmz|*/'\n    text-align: center\n    min-width: 320px\n    margin: 0px auto\n  ' /*|cmz*/)]);
