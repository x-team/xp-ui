...
var cardTheme = {
  ...
  avatar: cmz.named('AutoUI_ui_ApplicantBadge-62', /*cmz|*/'\n    grid-area: avatar\n    width: 90px\n    height: 90px\n    cursor: pointer\n  ' /*|cmz*/),
  controls: cmz.named('AutoUI_ui_ApplicantBadge-68', /*cmz|*/'\n    grid-area: control\n    display: flex\n    visibility: hidden\n    opacity: 0\n    transition: visibility 0s linear 0.2s, opacity 0.2s linear\n  ' /*|cmz*/),
  control: cmz.named('AutoUI_ui_ApplicantBadge-75', '\n    & {\n      display: inline-block\n      padding: 0\n      margin: 0 0 0 5px\n      border: 0\n      border-radius: 2px\n      cursor: pointer\n      width: 20px\n      height: 20px\n      text-align: center\n      line-height: 1\n    }\n\n    &:hover {\n      background: ' + _theme2.default.baseRed + '\n    }\n\n    &:hover svg g,\n    &:hover svg polyline {\n      stroke: white\n    }\n  '),
  infos: cmz.named('AutoUI_ui_ApplicantBadge-98', /*cmz|*/'\n    grid-area: infos\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: flex-start\n    margin: 0 0 -10px\n  ' /*|cmz*/),
  info: cmz.named('AutoUI_ui_ApplicantBadge-106', _typo2.default.baseText, /*cmz|*/'\n      & {\n        margin: 0 20px 10px 0\n        white-space: nowrap\n      }\n\n      &:last-of-type {\n        margin-right: 0\n      }\n    ' /*|cmz*/),
  moreinfos: cmz.named('AutoUI_ui_ApplicantBadge-118', '\n    & {\n      font-size: 14px\n      margin: 0 0 10px 0\n      flex: 1\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),
  label: cmz.named('AutoUI_ui_ApplicantBadge-130', '\n    display: block\n    color: ' + _theme2.default.typoLabel + '\n  '),
  value: cmz.named('AutoUI_ui_ApplicantBadge-134', '\n    display: block\n    color: ' + _theme2.default.typoParagraph + '\n  '),
  tags: cmz.named('AutoUI_ui_ApplicantBadge-138', /*cmz|*/'\n    font-size: 14px\n    grid-area: tags\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: start\n    margin: 0 0 -10px\n  ' /*|cmz*/),
  tag: cmz.named('AutoUI_ui_ApplicantBadge-147', '\n    & {\n      border: 1px solid ' + _theme2.default.lineSilver2 + '\n      border-radius: 3px\n      padding: 0 10px\n      text-transform: uppercase\n      margin: 0 10px 10px 0\n      white-space: nowrap\n      color: ' + _theme2.default.typoParagraph + '\n    }\n\n    &:last-of-type {\n      margin-right: 0\n    }\n  '),
  moretags: cmz.named('AutoUI_ui_ApplicantBadge-162', '\n    & {\n      border: none\n      padding: 0 0 0 20px\n      text-transform: initial\n      margin: 0 0 10px 0\n      flex: 1\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),
  children: cmz.named('AutoUI_ui_ApplicantBadge-176', /*cmz|*/'\n    grid-column: 2 / -1;\n    grid-row: 2 / -1;\n  ' /*|cmz*/)
};

cardTheme.displayControlsOnHover = cmz.named('AutoUI_ui_ApplicantBadge-182', '\n  &:hover .' + cardTheme.controls + ' {\n    visibility: visible\n    opacity: 1\n    transition-delay: 0s\n  }\n');
