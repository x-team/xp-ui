...
var styles = {
  dropdown: cmz.named('AutoUI_ui_Dropdown-15', _typo2.default.baseText, /*cmz|*/'\n      position: relative\n      display: inline-block\n    ' /*|cmz*/),
  label: cmz.named('AutoUI_ui_Dropdown-22', /*cmz|*/'\n    & {\n      font-weight: 600\n      cursor: pointer\n      display: flex\n      align-items: center\n      justify-content: center\n      line-height: 16px\n    }\n\n    & > * {\n      margin: 0 0 0 6px\n    }\n\n    & > :first-child {\n      margin: 0\n    }\n  ' /*|cmz*/),
  ...
  contentvisible: cmz.named('AutoUI_ui_Dropdown-58', /*cmz|*/'\n    visibility: visible\n    opacity: 1\n    transition-delay: 0s\n  ' /*|cmz*/),
  contentright: cmz.named('AutoUI_ui_Dropdown-63', /*cmz|*/'\n    right: 0\n  ' /*|cmz*/)
};
...
var Dropdown = function (_PureComponent) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var contentClasses = [styles.content, open ? styles.contentvisible : '', position === 'right' ? styles.contentright : ''].join(' ');
...
var styles = {
  selectbox: cmz.named('AutoUI_ui_SelectBox-14', /*cmz|*/'\n    background: #fff\n    position: relative\n    width: 100%\n  ' /*|cmz*/),
  dropdown: cmz.named('AutoUI_ui_SelectBox-19', /*cmz|*/'\n    width: 100%\n  ' /*|cmz*/),
  placeholder: cmz.named('AutoUI_ui_SelectBox-22', _typo2.default.baseText, '\n      color: ' + _theme2.default.baseDark + '\n      border: 1px solid #E9EDEE\n      padding: 20px\n      height: 60px\n      width: 100%\n      box-sizing: border-box\n      display: flex\n      align-items: center\n      position: relative\n    '),
  search: cmz.named('AutoUI_ui_SelectBox-36', /*cmz|*/'\n    position: relative\n  ' /*|cmz*/),
  // The !important used below is required to override the global input[type="text"] styles
  searchinput: cmz.named('AutoUI_ui_SelectBox-40', /*cmz|*/'\n    padding: 23px 30px 20px 52px !important\n    height: 60px !important\n    width: 100%\n  ' /*|cmz*/),
  magnifier: cmz.named('AutoUI_ui_SelectBox-45', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: 23px\n      left: 22px\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  triangle: cmz.named('AutoUI_ui_SelectBox-57', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: 50%\n      right: 30px\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  close: cmz.named('AutoUI_ui_SelectBox-69', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: calc(50% - 7px)\n      right: 40px\n      cursor: pointer\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  label: cmz.named('AutoUI_ui_SelectBox-82', _typo2.default.baseText, /*cmz|*/'\n      line-height: 1\n    ' /*|cmz*/),
  labelevent: cmz.named('AutoUI_ui_SelectBox-88', _typo2.default.baseText, /*cmz|*/'\n      line-height: 1\n      font-style: italic\n    ' /*|cmz*/),
  list: cmz.named('AutoUI_ui_SelectBox-95', /*cmz|*/'\n    list-style: none\n    margin: 0\n    padding: 0\n    border: 1px solid #E9EDEE\n    border-top: none\n    overflow-y: scroll\n    background: #fff\n    width: 100%\n    box-sizing: border-box\n  ' /*|cmz*/),
  shadow: cmz.named('AutoUI_ui_SelectBox-106', /*cmz|*/'\n    box-shadow: 0 5px 12px rgba(0, 0, 0, 0.15)\n  ' /*|cmz*/),
  item: cmz.named('AutoUI_ui_SelectBox-109', /*cmz|*/'\n    & {\n      min-height: 30px\n      margin: 22px\n      display: flex\n      justify-content: space-between\n      align-items: center\n    }\n\n    &:last-child {\n      border-bottom: none\n    }\n  ' /*|cmz*/),
  lined: cmz.named('AutoUI_ui_SelectBox-122', /*cmz|*/'\n    border-bottom: 1px solid #E9EDEE\n    margin: 0 22px\n    padding: 15px 0\n  ' /*|cmz*/),
  editing: cmz.named('AutoUI_ui_SelectBox-127', '\n    & input {\n      border-bottom: 1px solid ' + _theme2.default.baseRed + '\n    }\n  '),
  control: cmz.named('AutoUI_ui_SelectBox-132', /*cmz|*/'\n    flex-shrink: 0\n    display: flex\n  ' /*|cmz*/),
  controlbutton: cmz.named('AutoUI_ui_SelectBox-136', /*cmz|*/'\n    cursor: pointer\n    padding: 5px\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  saving: cmz.named('AutoUI_ui_SelectBox-142', _typo2.default.baseText),
  selecting: cmz.named('AutoUI_ui_SelectBox-143', _typo2.default.baseText, /*cmz|*/'\n      padding: 0 0 0 13px\n    ' /*|cmz*/),
  editinput: cmz.named('AutoUI_ui_SelectBox-149', _typo2.default.baseText, /*cmz|*/'\n      & {\n        width: 70%\n        height: 30px\n      }\n\n      & input {\n        height: 30px\n        padding: 0\n        border-top: none\n        border-right: none\n        border-left: none\n      }\n    ' /*|cmz*/),
  nothinglabel: cmz.named('AutoUI_ui_SelectBox-166', _typo2.default.baseText, /*cmz|*/'\n      display: block\n      margin: 15px 22px\n    ' /*|cmz*/),
  createnew: cmz.named('AutoUI_ui_SelectBox-173', _typo2.default.baseText, '\n      & {\n        display: flex\n        align-items: center\n        margin: 15px 22px\n        color: ' + _theme2.default.baseRed + '\n        cursor: pointer\n      }\n\n      & svg {\n        transform: scale(0.7)\n        margin-right: 8px\n      }\n    ')
};
...
var SelectBox = function (_Component) {
  ...
  function SelectBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectBox.__proto__ || Object.getPrototypeOf(SelectBox)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      creating: false
    }, _this.mapItemsInput = function (items) {
      ...
      var newItems = view && view.map(function (each, i) {
      ...
      if (!item.selecting && onSelect && typeof onSelect().then === 'function') {
        _this.updateItemsState(_extends({}, _this.state.view.find(function (obj) {
          return obj.id === item.id;
        }), {
          selecting: true
        }));
        onSelect(_extends({}, _this.state.view.find(function (obj) {
          return obj.id === item.id;
        }), {
          selected: !item.selected
        })).then(function (reponseItem) {
          var uncachedItem = _this.state.view.find(function (obj) {
            return obj.id === reponseItem.id;
          });
          uncachedItem && _this.updateItemsState(_extends({}, uncachedItem, {
            selected: !item.selected,
            selecting: false
          }));
        });
      ...
      if (!item.selecting && onClick && typeof onClick().then === 'function') {
        ...
        onClick(_extends({}, _this.state.view.find(function (obj) {
          return obj.id === item.id;
        }), {
          selected: !item.selected
        })).then(function (reponseItem) {
      ...
      if (!creating && onCreateNew && typeof onCreateNew().then === 'function') {
        ...
        onCreateNew(search).then(function (reponseItem) {
          _this.setState(function () {
            return { view: [].concat(_toConsumableArray(_this.state.view), [reponseItem]), creating: false };
          });
          _this.handleSearch('');
        });
      }
      ...
      if (onEdit && typeof onEdit().then === 'function') {
        ...
        onEdit(_extends({}, _this.state.view.find(function (obj) {
          return obj.id === item.id;
        }), {
          value: item.editing
        })).then(function (reponseItem) {
          ...
          _this.updateItemsState(_extends({}, uncachedItem, {
  ...
  _createClass(SelectBox, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          itemsHeight = _props.itemsHeight,
          width = _props.width,
      ...
      var renderEditable = function renderEditable(item) {
        return onEdit && _react2.default.createElement(
          ...
          { className: styles.controlbutton, onClick: function onClick() {
              return _this2.handleStartEditing(item);
            } },
        ...
        return item.saving ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_InputField2.default, {
              ...
              onChange: function onChange() {
                ...
                return _this2.handleEditChange(item, input);
              },
              autoFocus: 'autofocus',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'span',
              { className: styles.controlbutton, onClick: function onClick() {
                  return _this2.handleCancelEdit(item);
                } },
              _react2.default.createElement(_SvgIcon2.default, { icon: 'x', color: 'grayscale' })
            ),
            _react2.default.createElement(
        ...
        return filteredItems && filteredItems.length > 0 ? filteredItems.map(function (item) {
          ...
          creating ? _react2.default.createElement(
            ...
            onCreateNew && _react2.default.createElement(
              'span',
              { className: styles.createnew, onClick: _this2.handleCreateNew },
      ...
      var renderSearchLabel = function renderSearchLabel() {
        return placeholder === 'Search' ? _react2.default.createElement(
          ...
          _react2.default.createElement(_InputField2.default, {
            ...
            onChange: function onChange() {
              var input = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
              return _this2.handleSearch(input.target.value);
            },
