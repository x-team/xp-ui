...
var _webfontloader = __webpack_require__(24);
...
var _ApplicantListFilter = __webpack_require__(23);
...
var containerStyles = cmz.named('AutoUI_ApplicantBadge-8', /*cmz|*/'\n  display: flex\n  flex-direction: row\n  font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif\n  margin: .5em .5em .5em 0\n' /*|cmz*/);

var applicantsContainer = cmz.named('AutoUI_ApplicantBadge-15', /*cmz|*/'\n  margin: 0 1em\n  padding-top: .5em\n  padding-right: .5em\n' /*|cmz*/);

var activeApplicantClassName = cmz.named('AutoUI_ApplicantBadge-21', 'background-color: ' + _theme2.default.lightGray);
...
var ApplicantBadge = function (_PureComponent) {
  ...
  _createClass(ApplicantBadge, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: containerStyles + ' ' + (active && activeApplicantClassName) },
        ...
        _react2.default.createElement(
          'div',
          { className: applicantsContainer + ' ' + (active && activeApplicantClassName) },
