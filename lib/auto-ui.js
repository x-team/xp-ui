...
var addSemis = __webpack_require__(42);
var upsertCss = __webpack_require__(43);
var uniquifyName = __webpack_require__(44);
...
var getIcon = function getIcon(_ref) {
  ...
  var icons = {
    ...
    paperplane: _react2.default.createElement(
      'svg',
      { width: '17px', height: '13px', viewBox: '0 0 17 17' },
      _react2.default.createElement(
        'g',
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'size', 'color', 'outlined', 'disabled', 'rounded', 'raised', 'pseudolink', 'selected', 'block', 'wide', 'selectbox', 'component', 'children']);

      var colorClassName = colorStyles[color] || '';
      var sizeClassName = sizeStyles[size] || '';
      var extraClassName = [outlined && extraStyles.outlined, outlined && 'outlined', rounded && extraStyles.rounded, rounded && 'rounded', raised && extraStyles.raised, raised && 'raised', pseudolink && [extraStyles.outlined, extraStyles.pseudolink].join(' '), pseudolink && 'outlined pseudolink', selected && extraStyles.selected, selected && 'selected', block && extraStyles.block, wide && extraStyles.wide, selectbox && [extraStyles.wide, extraStyles.selectbox].join(' '), disabled && extraStyles.disabled].filter(Boolean).join(' ');
...
var _withAutosize = __webpack_require__(78);
...
var startOfWeek = __webpack_require__(94)
...
var styles = {
  selectbox: cmz.named('AutoUI_ui_SelectBox-17', '\n    background: ' + _theme2.default.baseBrighter + '\n    position: relative\n    width: 100%\n  '),
  dropdown: cmz.named('AutoUI_ui_SelectBox-22', /*cmz|*/'\n    width: 100%\n  ' /*|cmz*/),
  placeholder: cmz.named('AutoUI_ui_SelectBox-25', _typo2.default.baseText, '\n      border: 1px solid ' + _theme2.default.lineSilver2 + '\n      padding: 0 20px\n      height: 60px\n      width: 100%\n      box-sizing: border-box\n      display: flex\n      align-items: center\n      position: relative\n      border-radius: 2px\n    '),
  selects: cmz.named('AutoUI_ui_SelectBox-39', '\n    & {\n      width: 100%\n    }\n\n    & > div {\n      display: block\n      line-height: 1.1\n    }\n\n    & > div:first-of-type {\n      font-size: 15px\n      color: ' + _theme2.default.typoLabel + '\n      padding: 10px 0 0\n      transition: color 0.15s ease-out, font-size 0.15s ease-out\n    }\n\n    & > div:last-of-type {\n      width: calc(100% - 20px)\n      white-space: nowrap\n      overflow: auto\n      padding: 0 0 10px\n      transition: visibility 0s, opacity 0.15s ease-out, padding 0.15s ease-out\n      visibility: visible\n      opacity: 1\n    }\n  '),
  selectsEmpty: cmz.named('AutoUI_ui_SelectBox-66', /*cmz|*/'\n    & > div:first-of-type {\n      transition: color 0.15s ease-out, font-size 0.15s ease-out\n    }\n\n    & > div:last-of-type {\n      transition: visibility 1s, opacity 0.15s ease-out, padding 0.15s ease-out\n      visibility: hidden\n      opacity: 0\n    }\n  ' /*|cmz*/),
  search: cmz.named('AutoUI_ui_SelectBox-77', /*cmz|*/'\n    position: relative\n  ' /*|cmz*/),
  // The !important used below is required to override the global input[type="text"] styles
  searchinput: cmz.named('AutoUI_ui_SelectBox-81', /*cmz|*/'\n    padding: 23px 30px 20px 52px !important\n    height: 60px !important\n    width: 100%\n  ' /*|cmz*/),
  magnifier: cmz.named('AutoUI_ui_SelectBox-86', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: 23px\n      left: 22px\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  triangle: cmz.named('AutoUI_ui_SelectBox-98', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: 50%\n      right: 30px\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  close: cmz.named('AutoUI_ui_SelectBox-110', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: calc(50% - 7px)\n      right: 40px\n      cursor: pointer\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  label: cmz.named('AutoUI_ui_SelectBox-123', _typo2.default.baseText, /*cmz|*/'\n      line-height: 1\n    ' /*|cmz*/),
  labelevent: cmz.named('AutoUI_ui_SelectBox-129', _typo2.default.baseText, /*cmz|*/'\n      line-height: 1\n      font-style: italic\n    ' /*|cmz*/),
  list: cmz.named('AutoUI_ui_SelectBox-136', '\n    & {\n      list-style: none\n      margin: 0\n      padding: 0\n      border: 1px solid ' + _theme2.default.lineSilver2 + '\n      border-top: none\n      overflow-y: scroll\n      background: ' + _theme2.default.baseBrighter + '\n      width: 100%\n      box-sizing: border-box\n    }\n\n    &:not(.expanded):empty {\n      border: none\n    }\n  '),
  shadow: cmz.named('AutoUI_ui_SelectBox-153', /*cmz|*/'\n    box-shadow: 0 5px 12px rgba(0, 0, 0, 0.15)\n  ' /*|cmz*/),
  item: cmz.named('AutoUI_ui_SelectBox-156', _typo2.default.baseText, '\n    & {\n      min-height: 30px\n      padding: 15px 22px\n      display: flex\n      justify-content: space-between\n      align-items: center\n    }\n\n    &:hover {\n      background-color: ' + _theme2.default.baseBright + '\n    }\n\n    &:last-child::after {\n      background-color: transparent\n    }\n\n    &:not(.isSaving):not(.isSelecting):hover .editButton {\n      display: flex\n    }\n  '),
  lined: cmz.named('AutoUI_ui_SelectBox-177', '\n    & {\n      position: relative\n    }\n\n    &::after {\n      content: \'\'\n      display: block\n      height: 1px\n      width: calc(100% - 30px)\n      position: absolute\n      bottom: 0\n      left: 15px\n      background-color: ' + _theme2.default.lineSilver2 + '\n    }\n  '),
  editing: cmz.named('AutoUI_ui_SelectBox-193', '\n    & input {\n      border-bottom: 1px solid ' + _theme2.default.baseRed + '\n    }\n  '),
  control: cmz.named('AutoUI_ui_SelectBox-198', /*cmz|*/'\n    flex-shrink: 0\n    display: flex\n  ' /*|cmz*/),
  controlbutton: cmz.named('AutoUI_ui_SelectBox-202', /*cmz|*/'\n    cursor: pointer\n    padding: 5px\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  editButton: cmz.named('AutoUI_ui_SelectBox-208', 'editButton', /*cmz|*/'\n    display: none\n  ' /*|cmz*/),
  selecting: cmz.named('AutoUI_ui_SelectBox-211', _typo2.default.baseText, /*cmz|*/'\n      padding: 0 0 0 30px\n      position: relative\n    ' /*|cmz*/),
  selectingdots: cmz.named('AutoUI_ui_SelectBox-218', '\n    & {\n      position: absolute\n      top: calc(50% - 9px)\n      left: 0\n      width: 20px\n      height: 20px\n      border-top-color: ' + _theme2.default.lineSilver2 + '\n      border-left-color: ' + _theme2.default.lineSilver2 + '\n      animation: spinner 400ms linear infinite\n      border-bottom-color: transparent\n      border-right-color: transparent\n      border-style: solid\n      border-width: 2px\n      border-radius: 50%\n      box-sizing: border-box\n      display: inline-block\n      vertical-align: middle\n    }\n\n    @keyframes spinner {\n      0% {\n        transform: rotate(0deg)\n      }\n      100% {\n        transform: rotate(360deg)\n      }\n    }\n  '),
  editinput: cmz.named('AutoUI_ui_SelectBox-247', _typo2.default.baseText, /*cmz|*/'\n      & {\n        width: 70%\n        height: 30px\n      }\n\n      & input {\n        height: 30px\n        padding: 0\n        border-top: none\n        border-right: none\n        border-left: none\n      }\n    ' /*|cmz*/),
  nothinglabel: cmz.named('AutoUI_ui_SelectBox-264', _typo2.default.baseText, /*cmz|*/'\n      display: block\n      margin: 15px 22px\n    ' /*|cmz*/),
  createnew: cmz.named('AutoUI_ui_SelectBox-271', _typo2.default.baseText, '\n      & {\n        display: flex\n        align-items: center\n        margin: 15px 22px\n        color: ' + _theme2.default.baseRed + '\n        cursor: pointer\n      }\n\n      & svg {\n        transform: scale(0.7)\n        margin-right: 8px\n      }\n    '),
  appendix: cmz.named('AutoUI_ui_SelectBox-288', '\n    border-right: 1px solid ' + _theme2.default.lineSilver2 + '\n    border-left: 1px solid ' + _theme2.default.lineSilver2 + '\n  ')
};
  ...
  function SelectBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectBox.__proto__ || Object.getPrototypeOf(SelectBox)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      return items.map(function (each, i) {
        ...
        var isEditing = (viewItem.editing || !each.editing) && each.value !== viewItem.editing;
        var newItem = {
          id: each.id,
          value: each.value,
      ...
      if (!Object.is(prevProps, this.props)) {
        ...
        this.setState(function (prevState, props) {
          var newState = _extends({}, prevState, {
            ...
            creating: _this2.props.creating !== 'undefined' ? _this2.props.creating : false
          });

          return newState;
        }, function () {
          if (_this2.state.search !== _this2.props.search) {
            _this2.handleSearch(_this2.props.search);
          }
        });
      }
    }
    ...
    value: function render() {
      ...
      var renderEditable = function renderEditable(item) {
        return onEdit && _react2.default.createElement(
          'span',
          { className: [styles.controlbutton, styles.editButton].join(' '), onClick: function onClick() {
      ...
      var itemClasses = function itemClasses(item) {
        return [styles.item, lined || !expanded ? styles.lined : '', item.editing && item.editing !== item.value ? styles.editing : '', item.saving ? 'isSaving' : '', item.selecting ? 'isSelecting' : ''].join(' ');
      };
      ...
      var renderItems = function renderItems() {
        return _react2.default.createElement(
          'ul',
          { className: [styles.list, expanded && 'expanded'].join(' '), style: {
              height: visibleItems && expanded ? visibleItems * 60 + 'px' : 'auto',
              maxHeight: visibleItems ? visibleItems * 60 + 'px' : 'auto',
              width: width ? width + 'px' : '100%'
            } },
          search && filteredItems && filteredItems.length === 0 && _react2.default.createElement(
            'li',
            null,
            _react2.default.createElement(
              'span',
            ...
            onCreateNew && !creating && _react2.default.createElement(
              'span',
...
var _markdownToJsx = __webpack_require__(101);
...
var _FileLinks = __webpack_require__(103);
...
exports.XIcon = exports.VideoPlayer = exports.Typography = exports.TruncatedList = exports.TextareaEditor = exports.Text = exports.Tabs = exports.Tab = exports.SvgIcon = exports.SolutionForm = exports.SelectBox = exports.RoadmapTimelineElement = exports.RoadmapLevel = exports.RoadmapHero = exports.Roadmap = exports.NotesFeed = exports.Note = exports.Modal = exports.MilestonesScreen = exports.Milestones = exports.Loader = exports.ListsEditor = exports.InputGroup = exports.InputField = exports.HorizontalRuler = exports.HeaderBar = exports.FooterList = exports.FooterBrands = exports.Footer = exports.FilterBar = exports.ErrorBox = exports.Dropdown = exports.ColorPalette = exports.CollapsibleSection = exports.Button = exports.Avatar = exports.AttachFiles = exports.ApplicantScreen = exports.ApplicantListFilter = exports.ApplicantGrid = exports.ApplicantBadge = undefined;

var _ApplicantBadge = __webpack_require__(39);

var _ApplicantBadge2 = _interopRequireDefault(_ApplicantBadge);

var _ApplicantGrid = __webpack_require__(57);

var _ApplicantGrid2 = _interopRequireDefault(_ApplicantGrid);

var _ApplicantListFilter = __webpack_require__(58);

var _ApplicantListFilter2 = _interopRequireDefault(_ApplicantListFilter);

var _ApplicantScreen = __webpack_require__(59);

var _ApplicantScreen2 = _interopRequireDefault(_ApplicantScreen);

var _AttachFiles = __webpack_require__(60);
...
var _CollapsibleSection = __webpack_require__(61);

var _CollapsibleSection2 = _interopRequireDefault(_CollapsibleSection);

var _ColorPalette = __webpack_require__(71);
...
var _ErrorBox = __webpack_require__(72);

var _ErrorBox2 = _interopRequireDefault(_ErrorBox);

var _FilterBar = __webpack_require__(73);
...
var _FooterBrands = __webpack_require__(75);

var _FooterBrands2 = _interopRequireDefault(_FooterBrands);

var _FooterList = __webpack_require__(76);
...
var _HorizontalRuler = __webpack_require__(77);
...
var _InputGroup = __webpack_require__(79);

var _InputGroup2 = _interopRequireDefault(_InputGroup);

var _ListsEditor = __webpack_require__(80);

var _ListsEditor2 = _interopRequireDefault(_ListsEditor);

var _Loader = __webpack_require__(29);

var _Loader2 = _interopRequireDefault(_Loader);

var _Milestones = __webpack_require__(30);

var _Milestones2 = _interopRequireDefault(_Milestones);

var _MilestonesScreen = __webpack_require__(83);
...
var _Note = __webpack_require__(31);

var _Note2 = _interopRequireDefault(_Note);

var _NotesFeed = __webpack_require__(107);
...
var _RoadmapHero = __webpack_require__(110);

var _RoadmapHero2 = _interopRequireDefault(_RoadmapHero);

var _RoadmapLevel = __webpack_require__(112);

var _RoadmapLevel2 = _interopRequireDefault(_RoadmapLevel);

var _RoadmapTimelineElement = __webpack_require__(35);

var _RoadmapTimelineElement2 = _interopRequireDefault(_RoadmapTimelineElement);

var _SelectBox = __webpack_require__(26);

var _SelectBox2 = _interopRequireDefault(_SelectBox);

var _SolutionForm = __webpack_require__(113);
...
var _TextareaEditor = __webpack_require__(115);
...
var _Typography = __webpack_require__(123);

var _Typography2 = _interopRequireDefault(_Typography);

var _VideoPlayer = __webpack_require__(124);

var _VideoPlayer2 = _interopRequireDefault(_VideoPlayer);

var _XIcon = __webpack_require__(125);
...
exports.ListsEditor = _ListsEditor2.default;
...
var _md = __webpack_require__(40);
...
var cardTheme = {
  mode: cmz.named('AutoUI_ui_ApplicantBadge-40', _typo2.default.baseText, '\n      & {\n        transition: all 0.4s ease-out\n        background: ' + _theme2.default.baseBrighter + '\n        border: 1px solid ' + _theme2.default.lineSilver2 + '\n        padding: 30px\n        display: grid\n        grid-template: \'avatar name control\' \'avatar infos infos\' \'tags tags tags\'\n        grid-template-columns: 90px 1fr auto\n        grid-template-rows: minmax(20px, auto) auto auto\n        grid-gap: 15px\n        margin: 0 10px\n        cursor: pointer\n      }\n\n      &:hover {\n        box-shadow: 0 1px 8px rgba(0, 0, 0, 0.2)\n      }\n    '),

  active: cmz.named('AutoUI_ui_ApplicantBadge-63', '\n    transition: all 0.2s ease-in\n    border: 1px solid ' + _theme2.default.baseRed + '\n    box-shadow: 0 1px 8px rgba(0, 0, 0, 0.2)\n    margin: 0\n    padding: 30px 40px\n  '),

  name: cmz.named('AutoUI_ui_ApplicantBadge-71', _typo2.default.badgeHeading, /*cmz|*/'\n      grid-area: name\n      display: flex\n      align-items: flex-end\n      font-size: 17px\n    ' /*|cmz*/),

  avatar: cmz.named('AutoUI_ui_ApplicantBadge-80', /*cmz|*/'\n    grid-area: avatar\n    width: 90px\n    height: 90px\n  ' /*|cmz*/),

  control: cmz.named('AutoUI_ui_ApplicantBadge-86', '\n    & {\n      display: inline-block\n      padding: 0\n      margin: 0 0 0 5px\n      border: 0\n      border-radius: 2px\n      cursor: pointer\n      width: 20px\n      height: 20px\n      text-align: center\n      line-height: 1\n    }\n\n    &:hover {\n      background: ' + _theme2.default.baseRed + '\n    }\n\n    &:hover svg g,\n    &:hover svg polyline {\n      stroke: white\n    }\n  '),

  controls: cmz.named('AutoUI_ui_ApplicantBadge-110', 'controls', /*cmz|*/'\n    grid-area: control\n    display: flex\n    visibility: hidden\n  ' /*|cmz*/),

  displayControlsOnHover: cmz.named('AutoUI_ui_ApplicantBadge-116', /*cmz|*/'\n    &:hover .controls {\n      visibility: visible\n    }\n  ' /*|cmz*/),

  infos: cmz.named('AutoUI_ui_ApplicantBadge-122', /*cmz|*/'\n    grid-area: infos\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: flex-start\n    margin: 0 0 -10px\n  ' /*|cmz*/),

  info: cmz.named('AutoUI_ui_ApplicantBadge-131', _typo2.default.baseText, /*cmz|*/'\n      & {\n        margin: 0 20px 10px 0\n      }\n\n      &:last-of-type {\n        margin-right: 0\n      }\n    ' /*|cmz*/),

  moreinfos: cmz.named('AutoUI_ui_ApplicantBadge-143', '\n    & {\n      color: ' + _theme2.default.typoLabel + '\n      font-size: 17px\n      margin: 0 0 10px 0\n      cursor: pointer\n      align-self: flex-end\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),

  label: cmz.named('AutoUI_ui_ApplicantBadge-157', '\n    display: block\n    color: ' + _theme2.default.typoLabel + '\n    white-space: nowrap\n    line-height: 1.2\n    font-size: 17px\n  '),

  value: cmz.named('AutoUI_ui_ApplicantBadge-165', '\n    display: block\n    color: ' + _theme2.default.typoParagraph + '\n    line-height: 1.2\n    font-size: 17px\n    white-space: normal\n  '),

  tip: cmz.named('AutoUI_ui_ApplicantBadge-173', '\n    font-size: 15px\n    color: ' + _theme2.default.typoParagraph + '\n    line-height: 1.4\n  '),

  tags: cmz.named('AutoUI_ui_ApplicantBadge-179', /*cmz|*/'\n    font-size: 14px\n    grid-area: tags\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: start\n    margin: 0 0 -10px\n  ' /*|cmz*/),

  tag: cmz.named('AutoUI_ui_ApplicantBadge-189', '\n    & {\n      border: 1px solid ' + _theme2.default.lineSilver2 + '\n      border-radius: 3px\n      padding: 0 10px\n      text-transform: uppercase\n      margin: 0 10px 10px 0\n      white-space: nowrap\n      color: ' + _theme2.default.typoParagraph + '\n    }\n\n    &:last-of-type {\n      margin-right: 0\n    }\n  '),

  moretags: cmz.named('AutoUI_ui_ApplicantBadge-205', '\n    & {\n      border: none\n      padding: 0 0 0 20px\n      text-transform: initial\n      margin: 0 0 10px 0\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),

  purelabel: cmz.named('AutoUI_ui_ApplicantBadge-219', '\n    border: none\n    color: ' + _theme2.default.typoLabel + '\n    font-size: 17px\n  '),

  children: cmz.named('AutoUI_ui_ApplicantBadge-225', /*cmz|*/'\n    grid-column: 1 / -1\n    grid-row: 4 / -1\n  ' /*|cmz*/)
};
  ...
  _createClass(ApplicantBadge, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          avatar = _props.avatar,
          children = _props.children,
          displayApprovalIcon = _props.displayApprovalIcon,
          renderApprovalDropdown = _props.renderApprovalDropdown,
          displayExclusionIcon = _props.displayExclusionIcon,
          renderExclusionDropdown = _props.renderExclusionDropdown;
      ...
      return id ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          displayApprovalIcon && _react2.default.createElement(
            _Dropdown2.default,
            {
              tooltip: true,
              label: _react2.default.createElement(
          ...
          displayExclusionIcon && _react2.default.createElement(
            _Dropdown2.default,
            {
              tooltip: true,
              label: _react2.default.createElement(
...
var colorString = __webpack_require__(46);
...
var swizzle = __webpack_require__(47);
...
var isArrayish = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fbjs_lib_shallowEqual__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_change_emitter__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_symbol_observable__ = __webpack_require__(66);
...
var cx = {
  listseditor: cmz.named('AutoUI_ui_ListsEditor-42', /*cmz|*/'\n    position: relative\n    width: 500px\n    max-width: 100%\n  ' /*|cmz*/),
  heading: cmz.named('AutoUI_ui_ListsEditor-47', _typo2.default.sectionHeading, /*cmz|*/'\n      margin: 0\n      padding: 30px\n    ' /*|cmz*/),
  listing: cmz.named('AutoUI_ui_ListsEditor-54', ''),
  control: cmz.named('AutoUI_ui_ListsEditor-55', /*cmz|*/'\n    display: flex\n    justify-content: space-between\n    margin: 40px 0\n    padding: 0 20px\n  ' /*|cmz*/),
  button: cmz.named('AutoUI_ui_ListsEditor-61', /*cmz|*/'\n    & {\n      border-color: transparent\n      margin: 0\n    }\n\n    &:hover {\n      border-color: transparent\n    }\n  ' /*|cmz*/),
  save: cmz.named('AutoUI_ui_ListsEditor-71', /*cmz|*/'\n    padding-right: 70px\n    padding-left: 70px\n    margin: 0\n  ' /*|cmz*/),
  tabs: cmz.named('AutoUI_ui_ListsEditor-76', '\n    & {\n      margin: 0\n    }\n\n    & nav {\n      margin: 0\n      padding: 0\n    }\n\n    & nav ul {\n      display: flex\n      justify-content: space-around\n      background: silver\n      background-color: ' + _theme2.default.baseBright + '\n      border-color: ' + _theme2.default.baseBright + '\n      margin: 0\n    }\n\n    & nav ul li {\n      margin: 0\n      padding: 0\n      text-align: center\n    }\n\n    & nav ul li a {\n      padding: 10px 40px\n    }\n\n    & > div > div {\n      margin: 0\n    }\n  '),
  saving: cmz.named('AutoUI_ui_ListsEditor-109', /*cmz|*/'\n    position: absolute\n    top: 0\n    width: 100%\n    height: 100%\n    background: rgba(255, 255, 255, 0.65)\n    z-index: 10\n    display: flex\n    justify-content: center\n    align-items: center\n  ' /*|cmz*/)
};
...
var ListsEditor = function (_Component) {
  ...
  function ListsEditor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ListsEditor.__proto__ || Object.getPrototypeOf(ListsEditor)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      search: '',
      editing: false,
      activeList: _this.props.list.filter(function (item) {
        return !item.archived;
      }),
      archiveList: _this.props.list.filter(function (item) {
        return item.archived;
      })
    }, _this.handleSearch = function (search) {
      _this.setState({ search: search });
    }, _this.handleCreateNew = function (name) {
      _this.setState(function () {
        return {
          search: '',
          editing: true,
          activeList: [{ id: +new Date(), value: name }].concat(_toConsumableArray(_this.state.activeList))
        };
      });
    }, _this.handleEdit = function (item) {
      var _this$state = _this.state,
          activeList = _this$state.activeList,
          archiveList = _this$state.archiveList;

      var isActive = activeList.some(function (each) {
        return each.id === item.id;
      });
      _this.setState(function () {
        return {
          editing: true,
          activeList: isActive ? activeList.map(function (each) {
            return each.id === item.id ? _extends({}, item, { editing: false }) : each;
          }) : activeList,
          archiveList: !isActive ? archiveList.map(function (each) {
            return each.id === item.id ? _extends({}, item, { editing: false }) : each;
          }) : archiveList
        };
      });
      ...
      var _this$state2 = _this.state,
          activeList = _this$state2.activeList,
          archiveList = _this$state2.archiveList;
      ...
      _this.setState(function () {
        return {
          activeList: isActive ? activeList.map(function (each) {
            return each.id === item.id ? _extends({}, item) : each;
          }) : activeList,
          archiveList: !isActive ? archiveList.map(function (each) {
            return each.id === item.id ? _extends({}, item) : each;
          }) : archiveList
    ...
    }, _this.handleArchive = function (event) {
      var active = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

      event && event.stopPropagation();
      var _this$state3 = _this.state,
          activeList = _this$state3.activeList,
          archiveList = _this$state3.archiveList;

      _this.setState(function () {
        return {
          editing: true,
          activeList: active ? [].concat(_toConsumableArray(activeList.filter(function (each) {
            return !each.selected;
          })), _toConsumableArray(archiveList.filter(function (each) {
            return each.selected;
          }).map(function (each) {
            return _extends({}, each, { selected: false, archived: false });
          }))) : [].concat(_toConsumableArray(activeList), _toConsumableArray(archiveList.filter(function (each) {
            return each.selected;
          }).map(function (each) {
            return _extends({}, each, { selected: false, archived: false });
          }))),
          archiveList: !active ? [].concat(_toConsumableArray(archiveList.filter(function (each) {
            return !each.selected;
          })), _toConsumableArray(activeList.filter(function (each) {
            return each.selected;
          }).map(function (each) {
            return _extends({}, each, { selected: false, archived: true });
          }))) : [].concat(_toConsumableArray(archiveList), _toConsumableArray(activeList.filter(function (each) {
            return each.selected;
          }).map(function (each) {
            return _extends({}, each, { selected: false, archived: true });
          })))
      ...
      var _this$state4 = _this.state,
          activeList = _this$state4.activeList,
          archiveList = _this$state4.archiveList;

      _this.setState(function () {
        return {
          editing: true,
          activeList: active ? activeList.filter(function (each) {
            return !each.selected;
          }) : activeList,
          archiveList: !active ? archiveList.filter(function (each) {
            return !each.selected;
          }) : archiveList
        };
      });
      ...
      var _this$state5 = _this.state,
          activeList = _this$state5.activeList,
          archiveList = _this$state5.archiveList;
      var onSave = _this.props.onSave;

      onSave && onSave([].concat(_toConsumableArray(activeList), _toConsumableArray(archiveList)).map(function (each) {
        return {
          id: each.id,
          value: each.value,
  ...
  _createClass(ListsEditor, [{
    ...
    value: function render() {
      ...
      var _state = this.state,
          ...
          archiveList = _state.archiveList;

      return _react2.default.createElement(
        'div',
        { className: cx.listseditor },
        _react2.default.createElement(
          'h1',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(_SelectBox2.default, {
                ...
                onCreateNew: function onCreateNew(listName) {
                  return _this2.handleCreateNew(listName);
                }
              }),
              _react2.default.createElement(
                'div',
                ...
                _react2.default.createElement(
                  'div',
                  null,
                  this.hasSelected(activeList) && _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
                      _Button2.default,
                      { onClick: function onClick(e) {
                          return _this2.handleArchive(e, true);
                        }, className: cx.button, outlined: true },
                      'Archive'
                    ),
                    _react2.default.createElement(
                      _Button2.default,
                      { onClick: function onClick(e) {
                          return _this2.handleDelete(e, true);
                        }, className: cx.button, outlined: true },
                      'Delete'
                    )
                  )
                ...
                _react2.default.createElement(
                  _Button2.default,
                  { disabled: !editing || saving, onClick: this.handleSave, className: cx.save },
                  'Save'
                )
              )
            )
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  null,
                  this.hasSelected(archiveList) && _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
                      _Button2.default,
                      { onClick: function onClick(e) {
                          return _this2.handleArchive(e, false);
                        }, className: cx.button, outlined: true },
                      'Unarchive'
                    ),
                    _react2.default.createElement(
                      _Button2.default,
                      { onClick: function onClick(e) {
                          return _this2.handleDelete(e, false);
                        }, className: cx.button, outlined: true },
                      'Delete'
                    )
                  )
...
var cx = {
  modal: cmz.named('AutoUI_ui_Modal-21', /*cmz|*/'\n    & {\n      background: rgba(0, 0, 0, 0.3)\n      height: 100%\n      width: 100%\n      position: absolute\n      display: flex\n      overflow: auto\n      padding: 30px\n      box-sizing: border-box\n      z-index: 9999\n      transition: opacity 0.3s ease-in, visibility 0.3s ease-in\n      opacity: 0\n      visibility: hidden\n    }\n\n    &.open {\n      opacity: 1\n      visibility: visible\n    }\n  ' /*|cmz*/),
  frame: cmz.named('AutoUI_ui_Modal-42', /*cmz|*/'\n    position: relative\n    background: white\n    margin: auto\n    max-width: 100%\n    min-width: 38px\n    min-height: 40px\n  ' /*|cmz*/),
  close: cmz.named('AutoUI_ui_Modal-50', 'closemodal', /*cmz|*/'\n    position: absolute\n    right: 12px\n    top: 12px\n    cursor: pointer\n  ' /*|cmz*/)
};
...
var Modal = function (_Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function render() {
      ...
      var modalClasses = [cx.modal, this.state.open && 'open'].join(' ');
      return children ? _react2.default.createElement(
        'div',
        { className: modalClasses, onClick: this.handleClose },
        _react2.default.createElement(
          'section',
          { className: cx.frame, onClick: this.noClick },
          children,
          _react2.default.createElement(
            'a',
            { className: cx.close, onClick: this.handleClose },
            _react2.default.createElement(_SvgIcon2.default, { icon: 'x', color: 'grayscale' })
          )
        )
      ) : null;
...
var getISOWeek = __webpack_require__(93)
var getISOYear = __webpack_require__(33)
var parse = __webpack_require__(7)
var isValid = __webpack_require__(96)
var enLocale = __webpack_require__(97)
...
var parse = __webpack_require__(7)
var startOfYear = __webpack_require__(90)
var differenceInCalendarDays = __webpack_require__(91)
...
var startOfDay = __webpack_require__(92)
...
var parse = __webpack_require__(7)
var startOfISOWeek = __webpack_require__(18)
var startOfISOYear = __webpack_require__(95)
...
var buildFormattingTokensRegExp = __webpack_require__(100)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_unquote__ = __webpack_require__(102);
...
var _FileLink = __webpack_require__(106);
...
RoadmapHero.defaultProps = {
  imgUrl: __webpack_require__(111),
  hasDivider: true
};
...
var _MediumEditorWrapper = __webpack_require__(116);
...
var MediumEditor = __webpack_require__(122);
