...
exports.default = {
  ...
  heading: cmz.named('AutoUI_typo-130', textRendering, typeface.extraHeading, '\n      text-transform: uppercase\n      font-size: 22px\n      margin: 0 0 .5rem\n      color: ' + _theme2.default.typoHeading + '\n      letter-spacing: -.61px\n      line-height: 30px\n    '),

  // RoadmapLevel's level text, applicant's badge name
  subheading: cmz.named('AutoUI_typo-144', textRendering, typeface.strongHeading, '\n      font-size: 18px\n      color: ' + _theme2.default.typoSubheading + '\n      margin: .625rem 0\n      letter-spacing: -.15px\n      line-height: 24px\n    '),

  // milestone levelN text, button value
  labelText: cmz.named('AutoUI_typo-157', textRendering, typeface.extra, /*cmz|*/'\n      font-size: 12px\n      text-transform: uppercase\n      line-height: 18px\n    ' /*|cmz*/),

  // regular text
  baseText: cmz.named('AutoUI_typo-168', textRendering, typeface.text, '\n      font-size: 20px\n      color: ' + _theme2.default.typoParagraph + '\n      line-height: 30px\n    '),

  // form input values
  formText: cmz.named('AutoUI_typo-179', textRendering, typeface.text, '\n      font-size: 18px\n      color: ' + _theme2.default.formText + '\n      line-height: 30px\n    '),

  // text divider
  divider: cmz.named('AutoUI_typo-190', '\n    & {\n      display: block\n      position: relative\n      width: 3.5rem\n      height: 2px\n      margin: 40px 0 35px\n      background-color: ' + _theme2.default.lineRed + '\n    }\n\n    @media screen and (max-width: ' + _theme.breakpoints.sm + ') {\n      & {\n        width: 2rem\n      }\n    }\n  ')
};
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'size', 'color', 'outlined', 'disabled', 'rounded', 'raised', 'selected', 'block', 'pro', 'component', 'children']);

      var colorClassName = colorStyles[color] || '';
      var sizeClassName = sizeStyles[size] || '';
      var extraClassName = [outlined && extraStyles.outlined, outlined && 'outlined', rounded && extraStyles.rounded, rounded && 'rounded', raised && extraStyles.raised, raised && 'raised', selected && extraStyles.selected, selected && 'selected', block && extraStyles.block, disabled && extraStyles.disabled, selected && pro && extraStyles.pro].filter(Boolean).join(' ');
  ...
  function InputField() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = InputField.__proto__ || Object.getPrototypeOf(InputField)).call.apply(_ref, [this].concat(args))), _this), _this.renderField = function () {
      var _props = _this.props,
          ...
          rest = _objectWithoutProperties(_props, ['type', 'label', 'id', 'name', 'value', 'onChange', 'isInvalid', 'postText']);
  ...
  _createClass(InputField, [{
    ...
    value: function render() {
      ...
      return RootComponent(label ? _react2.default.createElement(
        'label',
        { id: labelId },
        !isSpecialType(type) && _react2.default.createElement(_Text2.default, { content: label }),
        this.renderField(),
        postLabel
      ) : this.renderField());
    }
...
var _reactClickOutside = __webpack_require__(59);
...
var styles = {
  dropdown: cmz.named('AutoUI_ui_Dropdown-16', _typo2.default.baseText, /*cmz|*/'\n      position: relative\n      display: inline-block\n    ' /*|cmz*/),
  label: cmz.named('AutoUI_ui_Dropdown-23', /*cmz|*/'\n    & {\n      font-weight: 600\n      cursor: pointer\n      display: flex\n      align-items: center\n      justify-content: center\n      line-height: 16px\n    }\n\n    & > * {\n      margin: 0 0 0 6px\n    }\n\n    & > :first-child {\n      margin: 0\n    }\n  ' /*|cmz*/),
  labelElement: cmz.named('AutoUI_ui_Dropdown-41', /*cmz|*/'\n    width: 100%\n    white-space: nowrap\n  ' /*|cmz*/),
  padded: cmz.named('AutoUI_ui_Dropdown-45', /*cmz|*/'\n    padding: 10px\n  ' /*|cmz*/),
  triangle: cmz.named('AutoUI_ui_Dropdown-48', /*cmz|*/'\n    transform: translateY(-3px)\n  ' /*|cmz*/),
  content: cmz.named('AutoUI_ui_Dropdown-51', /*cmz|*/'\n    position: absolute\n    z-index: 999\n    visibility: hidden\n    opacity: 0\n    transition: visibility 0s linear 0.2s, opacity 0.2s linear\n    width: inherit\n  ' /*|cmz*/),
...
var Dropdown = function (_PureComponent) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function render() {
      ...
      var contentClasses = [styles.content, open ? styles.contentvisible : '', targetOrigin === 'right' ? styles.contentright : ''].join(' ');
      ...
      return children || label || icon ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: labelClasses, onClick: function onClick() {
...
var _markdownToJsx = __webpack_require__(90);
...
var Root = _elem2.default.div(cmz.named('AutoUI_ui_Note-26', /*cmz|*/'\n  display: flex\n' /*|cmz*/));

var AvatarWrapper = _elem2.default.div(cmz.named('AutoUI_ui_Note-30', /*cmz|*/'\n  margin-right: 16px\n  flex-shrink: 0\n' /*|cmz*/));

var Body = _elem2.default.div(cmz.named('AutoUI_ui_Note-35', /*cmz|*/'\n  display: flex\n  flex-direction: column\n' /*|cmz*/));

var Name = _elem2.default.span(cmz.named('AutoUI_ui_Note-40', _typo2.default.headline, /*cmz|*/'\n    font-size: 16px\n    line-height: normal\n    margin: 0\n    text-transform: uppercase\n  ' /*|cmz*/));

var Time = _elem2.default.span(cmz.named('AutoUI_ui_Note-50', _typo2.default.baseText, /*cmz|*/'\n    font-size: 12px\n    line-height: 12px\n    margin-top: 8px\n    margin-bottom: 10px\n  ' /*|cmz*/));

var TextWrapper = _elem2.default.div(cmz.named('AutoUI_ui_Note-60', '\n    & p:first-of-type {\n      margin-top: 0\n    }\n\n    & p:last-of-type {\n      margin-bottom: 0\n    }\n\n    & a {\n      color: ' + _theme2.default.baseRed + '\n      text-decoration: none\n    }\n\n    & a:hover {\n      text-decoration: underline\n    }\n  '));
...
var _CollapsibleSection = __webpack_require__(48);

var _CollapsibleSection2 = _interopRequireDefault(_CollapsibleSection);

var _ColorPalette = __webpack_require__(58);
...
var _ErrorBox = __webpack_require__(64);

var _ErrorBox2 = _interopRequireDefault(_ErrorBox);

var _FilterBar = __webpack_require__(65);
...
var _FooterBrands = __webpack_require__(67);

var _FooterBrands2 = _interopRequireDefault(_FooterBrands);

var _FooterList = __webpack_require__(68);

var _FooterList2 = _interopRequireDefault(_FooterList);

var _HeaderBar = __webpack_require__(18);

var _HeaderBar2 = _interopRequireDefault(_HeaderBar);

var _HorizontalRuler = __webpack_require__(69);

var _HorizontalRuler2 = _interopRequireDefault(_HorizontalRuler);

var _InputField = __webpack_require__(13);

var _InputField2 = _interopRequireDefault(_InputField);

var _InputGroup = __webpack_require__(70);
...
var _Milestones = __webpack_require__(24);

var _Milestones2 = _interopRequireDefault(_Milestones);

var _MilestonesScreen = __webpack_require__(73);

var _MilestonesScreen2 = _interopRequireDefault(_MilestonesScreen);

var _Note = __webpack_require__(25);

var _Note2 = _interopRequireDefault(_Note);

var _NotesFeed = __webpack_require__(92);
...
var _RoadmapHero = __webpack_require__(99);

var _RoadmapHero2 = _interopRequireDefault(_RoadmapHero);

var _RoadmapLevel = __webpack_require__(101);

var _RoadmapLevel2 = _interopRequireDefault(_RoadmapLevel);

var _RoadmapTimelineElement = __webpack_require__(28);
...
var _SolutionForm = __webpack_require__(103);
...
var _TextareaEditor = __webpack_require__(107);

var _TextareaEditor2 = _interopRequireDefault(_TextareaEditor);

var _Typography = __webpack_require__(115);
...
var _XIcon = __webpack_require__(117);
...
var Avatar = _elem2.default.img(cmz.named('AutoUI_ui_ApplicantBadge-33', /*cmz|*/'height: 64px' /*|cmz*/));

var Info = _elem2.default.div(cmz.named('AutoUI_ui_ApplicantBadge-35', '\n  margin: 0 1em\n  padding-right: .5em\n  color: ' + _theme2.default.typoHighlight + '\n'));

var Name = _elem2.default.div(cmz.named('AutoUI_ui_ApplicantBadge-41', _typo2.default.badgeHeading, /*cmz|*/'\n    margin-bottom: .2em\n  ' /*|cmz*/));

var Email = _elem2.default.div(cmz.named('AutoUI_ui_ApplicantBadge-48', /*cmz|*/'font-size: .9em' /*|cmz*/));
...
;(function (root, factory) {
	if (true) {
		// CommonJS
		module.exports = exports = factory(__webpack_require__(34));
	}
...
var colorString = __webpack_require__(36);
...
var FileName = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-47', _typo2.default.baseText, /*cmz|*/'\n    width: 100%\n    font-size: 16px\n    line-height: 1\n  ' /*|cmz*/));

var FileAction = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-56', /*cmz|*/'\n  cursor: pointer\n' /*|cmz*/));

var FileProgress = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-60', '\n  position: absolute\n  bottom: -2px\n  display: block\n  height: 2px\n  width: 0\n  background-color: ' + _theme2.default.baseRed + '\n  transition: width 0.5s\n'));

var ButtonLabel = _elem2.default.span(cmz.named('AutoUI_ui_AttachFiles-70', /*cmz|*/'\n  padding: 0 20px\n' /*|cmz*/));

var HiddenInput = _elem2.default.input(cmz.named('AutoUI_ui_AttachFiles-74', /*cmz|*/'\n  width: 0.1px\n  height: 0.1px\n  opacity: 0\n  overflow: hidden\n  position: absolute\n  zIndex: -1\n' /*|cmz*/));
    ...
    value: function render() {
      ...
      var renderFiles = function renderFiles(files) {
        return files.length > 0 && FilesList(files.map(function (file) {
          ...
          }, FileName(file.filename), renderButton(file), renderProgress(file.progress));
        }));
      };

      return Root(renderFiles(files), HiddenInput({
        type: 'file',
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_fbjs_lib_shallowEqual__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_change_emitter__ = __webpack_require__(52);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_symbol_observable__ = __webpack_require__(53);
...
var getDayOfYear = __webpack_require__(78)
var getISOWeek = __webpack_require__(82)
var getISOYear = __webpack_require__(27)
var parse = __webpack_require__(6)
var isValid = __webpack_require__(85)
var enLocale = __webpack_require__(86)
...
var parse = __webpack_require__(6)
var startOfYear = __webpack_require__(79)
...
var startOfDay = __webpack_require__(81)
...
var buildFormattingTokensRegExp = __webpack_require__(89)
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_unquote__ = __webpack_require__(91);
...
RoadmapHero.defaultProps = {
  imgUrl: __webpack_require__(100),
  hasDivider: true
};
...
var styles = {
  ...
  search: cmz.named('AutoUI_ui_SelectBox-37', /*cmz|*/'\n    position: relative\n  ' /*|cmz*/),
  // The !important used below is required to override the global input[type="text"] styles
  searchinput: cmz.named('AutoUI_ui_SelectBox-41', /*cmz|*/'\n    padding: 23px 30px 20px 52px !important\n    height: 60px !important\n    width: 100%\n  ' /*|cmz*/),
  magnifier: cmz.named('AutoUI_ui_SelectBox-46', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: 23px\n      left: 22px\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  triangle: cmz.named('AutoUI_ui_SelectBox-58', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: 50%\n      right: 30px\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  close: cmz.named('AutoUI_ui_SelectBox-70', /*cmz|*/'\n    & {\n      position: absolute\n      z-index: 5\n      top: calc(50% - 7px)\n      right: 40px\n      cursor: pointer\n    }\n\n    & svg {\n      position: absolute\n    }\n  ' /*|cmz*/),
  label: cmz.named('AutoUI_ui_SelectBox-83', _typo2.default.baseText, /*cmz|*/'\n      line-height: 1\n    ' /*|cmz*/),
  labelevent: cmz.named('AutoUI_ui_SelectBox-89', _typo2.default.baseText, /*cmz|*/'\n      line-height: 1\n      font-style: italic\n    ' /*|cmz*/),
  list: cmz.named('AutoUI_ui_SelectBox-96', '\n    list-style: none\n    margin: 0\n    padding: 0\n    border: 1px solid ' + _theme2.default.lineSilver2 + '\n    border-top: none\n    overflow-y: scroll\n    background: ' + _theme2.default.baseBrighter + '\n    width: 100%\n    box-sizing: border-box\n  '),
  shadow: cmz.named('AutoUI_ui_SelectBox-107', /*cmz|*/'\n    box-shadow: 0 5px 12px rgba(0, 0, 0, 0.15)\n  ' /*|cmz*/),
  item: cmz.named('AutoUI_ui_SelectBox-110', /*cmz|*/'\n    & {\n      min-height: 30px\n      margin: 22px\n      display: flex\n      justify-content: space-between\n      align-items: center\n    }\n\n    &:last-child {\n      border-bottom: none\n    }\n  ' /*|cmz*/),
  lined: cmz.named('AutoUI_ui_SelectBox-123', '\n    border-bottom: 1px solid ' + _theme2.default.lineSilver2 + '\n    margin: 0 22px\n    padding: 15px 0\n  '),
  editing: cmz.named('AutoUI_ui_SelectBox-128', '\n    & input {\n      border-bottom: 1px solid ' + _theme2.default.baseRed + '\n    }\n  '),
  control: cmz.named('AutoUI_ui_SelectBox-133', /*cmz|*/'\n    flex-shrink: 0\n    display: flex\n  ' /*|cmz*/),
  controlbutton: cmz.named('AutoUI_ui_SelectBox-137', /*cmz|*/'\n    cursor: pointer\n    padding: 5px\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  saving: cmz.named('AutoUI_ui_SelectBox-143', _typo2.default.baseText),
  selecting: cmz.named('AutoUI_ui_SelectBox-144', _typo2.default.baseText, /*cmz|*/'\n      padding: 0 0 0 30px\n      position: relative\n    ' /*|cmz*/),
  selectingdots: cmz.named('AutoUI_ui_SelectBox-151', '\n    & {\n      position: absolute\n      top: calc(50% - 9px)\n      left: 0\n      width: 20px\n      height: 20px\n      border-top-color: ' + _theme2.default.lineSilver2 + '\n      border-left-color: ' + _theme2.default.lineSilver2 + '\n      animation: spinner 400ms linear infinite\n      border-bottom-color: transparent\n      border-right-color: transparent\n      border-style: solid\n      border-width: 2px\n      border-radius: 50%\n      box-sizing: border-box\n      display: inline-block\n      vertical-align: middle\n    }\n\n    @keyframes spinner {\n      0% {\n        transform: rotate(0deg)\n      }\n      100% {\n        transform: rotate(360deg)\n      }\n    }\n  '),
  editinput: cmz.named('AutoUI_ui_SelectBox-180', _typo2.default.baseText, /*cmz|*/'\n      & {\n        width: 70%\n        height: 30px\n      }\n\n      & input {\n        height: 30px\n        padding: 0\n        border-top: none\n        border-right: none\n        border-left: none\n      }\n    ' /*|cmz*/),
  nothinglabel: cmz.named('AutoUI_ui_SelectBox-197', _typo2.default.baseText, /*cmz|*/'\n      display: block\n      margin: 15px 22px\n    ' /*|cmz*/),
  createnew: cmz.named('AutoUI_ui_SelectBox-204', _typo2.default.baseText, '\n      & {\n        display: flex\n        align-items: center\n        margin: 15px 22px\n        color: ' + _theme2.default.baseRed + '\n        cursor: pointer\n      }\n\n      & svg {\n        transform: scale(0.7)\n        margin-right: 8px\n      }\n    ')
};
  ...
  function SelectBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectBox.__proto__ || Object.getPrototypeOf(SelectBox)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (!creating && onCreateNew) {
        ...
        Promise.resolve(onCreateNew(search)).then(function (reponseItem) {
          _this.setState(function () {
            return {
  ...
  _createClass(SelectBox, [{
    ...
    value: function render() {
      ...
      var itemClasses = function itemClasses(item) {
        return [styles.item, expanded ? '' : styles.lined, item.editing && item.editing !== item.value ? styles.editing : ''].join(' ');
      };
      ...
      var renderSearchLabel = function renderSearchLabel() {
        return placeholder === 'Search' ? _react2.default.createElement(
          'div',
...
var _MediumEditorWrapper = __webpack_require__(108);
...
var Root = _elem2.default.div([utilStyles.maxWidth, _typo.typeface.text, cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-57', /*cmz|*/'\n    font-weight: 300\n    font-size: 18px\n    text-align: left\n    display: block\n    width: 100%\n    margin-bottom: 20px\n    box-sizing: border-box\n    min-width: 320px\n    margin: 0 auto\n  ' /*|cmz*/)]);

var editableClass = cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-70', /*cmz|*/'\n  resize: vertical\n  height: 156px\n' /*|cmz*/);

var largeClass = cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-75', /*cmz|*/'\n  height: 256px\n' /*|cmz*/);
...
var TextareaEditor = function (_PureComponent) {
  ...
  _createClass(TextareaEditor, [{
    ...
    value: function render() {
      ...
      var sizeClassName = large ? largeClass : '';
      ...
      return Root(_react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: editorContainerStyles + ' ' + editableClassName + ' ' + sizeClassName },
...
var MediumEditor = __webpack_require__(114);
...
var MediumEditorWrapper = function (_PureComponent) {
  ...
  function MediumEditorWrapper() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MediumEditorWrapper.__proto__ || Object.getPrototypeOf(MediumEditorWrapper)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function () {
  ...
  _createClass(MediumEditorWrapper, [{
    ...
    value: function render() {
      ...
      return (0, _elem2.default)('editable-' + id + ' ' + (options && options.disableEditing ? '' : 'editable'), { ref: function ref(node) {
          _this2.input = node;
        } })();
    }
  }]);
