...
var cardTheme = {
  mode: cmz.named('AutoUI_ui_ApplicantBadge-23', _typo2.default.baseText, '\n      border: 1px solid ' + _theme2.default.lineSilver2 + '\n      // max-width: 510px\n      padding: 30px\n      display: grid\n      grid-template: \'avatar name name control\' \'avatar infos infos infos\' \'tags tags tags tags\'\n      grid-template-columns: 90px 2fr 1fr\n      grid-template-rows: minmax(20px, auto) auto auto\n      grid-gap: 20px\n      margin: 0 10px\n    '),
  active: cmz.named('AutoUI_ui_ApplicantBadge-37', '\n    border: 1px solid ' + _theme2.default.baseRed + '\n    box-shadow: 0 3px 8px rgba(0, 0, 0, 0.15)\n    margin: 0\n  '),
  name: cmz.named('AutoUI_ui_ApplicantBadge-42', _typo2.default.badgeHeading, /*cmz|*/'\n      grid-area: name\n      display: flex\n      align-items: flex-end\n    ' /*|cmz*/),
  avatar: cmz.named('AutoUI_ui_ApplicantBadge-49', /*cmz|*/'\n    grid-area: avatar\n    width: 90px\n    height: 90px\n  ' /*|cmz*/),
  controls: cmz.named('AutoUI_ui_ApplicantBadge-54', /*cmz|*/'\n    grid-area: control\n    display: flex\n    visibility: hidden\n    opacity: 0\n    transition: visibility 0s linear 0.2s, opacity 0.2s linear\n  ' /*|cmz*/),
  control: cmz.named('AutoUI_ui_ApplicantBadge-61', '\n    & {\n      display: inline-block\n      padding: 0\n      margin: 0 0 0 5px\n      border: 0\n      border-radius: 2px\n      cursor: pointer\n      width: 20px\n      height: 20px\n      text-align: center\n      line-height: 1\n    }\n\n    &:hover {\n      background: ' + _theme2.default.baseRed + '\n    }\n\n    &:hover svg g,\n    &:hover svg polyline {\n      stroke: white\n    }\n  '),
  infos: cmz.named('AutoUI_ui_ApplicantBadge-84', /*cmz|*/'\n    grid-area: infos\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: flex-end\n    margin: 0 0 -10px\n  ' /*|cmz*/),
  info: cmz.named('AutoUI_ui_ApplicantBadge-92', _typo2.default.baseText, /*cmz|*/'\n      margin: 0 40px 10px 0\n      white-space: nowrap\n    ' /*|cmz*/),
  moreinfos: cmz.named('AutoUI_ui_ApplicantBadge-98', '\n    & {\n      font-size: 14px\n      margin: 0 0 10px 0\n      flex: 1\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),
  label: cmz.named('AutoUI_ui_ApplicantBadge-110', '\n    display: block\n    color: ' + _theme2.default.typoLabel + '\n  '),
  value: cmz.named('AutoUI_ui_ApplicantBadge-114', '\n    display: block\n    color: ' + _theme2.default.typoParagraph + '\n  '),
  tags: cmz.named('AutoUI_ui_ApplicantBadge-118', /*cmz|*/'\n    font-size: 14px\n    grid-area: tags\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: start\n    margin: 0 0 -10px\n  ' /*|cmz*/),
  tag: cmz.named('AutoUI_ui_ApplicantBadge-127', '\n    border: 1px solid ' + _theme2.default.lineSilver2 + '\n    border-radius: 3px\n    padding: 0 10px\n    text-transform: uppercase\n    margin: 0 10px 10px 0\n    white-space: nowrap\n    color: ' + _theme2.default.typoParagraph + '\n  '),
  moretags: cmz.named('AutoUI_ui_ApplicantBadge-136', '\n    & {\n      border: none\n      padding: 0 0 0 20px\n      text-transform: initial\n      margin: 0 0 10px 0\n      flex: 1\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),
  children: cmz.named('AutoUI_ui_ApplicantBadge-150', /*cmz|*/'\n    grid-column: 2 / -1;\n    grid-row: 2 / -1;\n  ' /*|cmz*/)
};

cardTheme.displayControlsOnHover = cmz.named('AutoUI_ui_ApplicantBadge-156', '\n  &:hover .' + cardTheme.controls + ' {\n    visibility: visible\n    opacity: 1\n    transition-delay: 0s\n  }\n');

var tabularTheme = {}; // to do:
