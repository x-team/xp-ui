  ...
  function SelectBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectBox.__proto__ || Object.getPrototypeOf(SelectBox)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      if (!item.selecting && onSelect) {
        ...
        Promise.resolve(onSelect(_extends({}, _this.state.view.find(function (obj) {
          return obj.id === item.id;
        }), {
          selected: !item.selected
        }))).then(function (reponseItem) {
          var currentItem = reponseItem || item;
      ...
      if (!item.selecting && onClick) {
        ...
        Promise.resolve(onClick(_extends({}, _this.state.view.find(function (obj) {
          return obj.id === item.id;
        }), {
          selected: !item.selected
        }))).then(function (reponseItem) {
      ...
      if (!creating && onCreateNew) {
        ...
        Promise.resolve(onCreateNew(search)).then(function (reponseItem) {
          reponseItem && _this.setState(function () {
      ...
      _this.updateItemsState(updatedItem);
    }, _this.handleEscKeyPress = function (e, item) {
      ...
      if (onEdit) {
        ...
        Promise.resolve(onEdit(_extends({}, _this.state.view.find(function (obj) {
          return obj.id === item.id;
        }), {
          value: item.editing
        }))).then(function (reponseItem) {
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_InputField2.default, {
              ...
              onKeyUp: function onKeyUp(e) {
                return _this3.handleEscKeyPress(e, item);
              }
            })
          ),
          _react2.default.createElement(
