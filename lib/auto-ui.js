...
var Divider = _elem2.default.span(cmz.named('AutoUI_Text-39', _typo2.default.divider));

var Content = _elem2.default.div(cmz.named('AutoUI_Text-41', _typo2.default.baseText, /*cmz|*/'margin: 15px 0' /*|cmz*/));

var centerAlign = cmz.named('AutoUI_Text-46', /*cmz|*/'text-align: center' /*|cmz*/);

var contentDividerCenter = cmz.named('AutoUI_Text-48', /*cmz|*/'\n  margin-left: auto\n  margin-right: auto\n' /*|cmz*/);
...
var styles = {
  ...
  icon: cmz.named('AutoUI_Milestones-88', '\n    & {\n      position: relative;\n      display: inline-block;\n      width: 1.9em;\n      height: 1.9em;\n      background-color: ' + _theme2.default.baseBrighter + ';\n      border: 2px solid ' + _theme2.default.lineSilver2 + ';\n      border-radius: 50%;\n      padding: .5em;\n      max-width: 100%;\n      transition: all .25s ease-out;\n      z-index: 10;\n      cursor: pointer;\n    }\n\n    .isCurrent & {\n      background-color: ' + _theme2.default.baseRed + ';\n      border-color: transparent;\n    }\n\n    .isComplete & {\n      background-color: ' + _theme2.default.baseBrighter + ';\n      border: 2px solid ' + _theme2.default.baseRed + ';\n    }\n\n    & > svg {\n      position: absolute;\n      top: 50%;\n      left: 50%;\n      transform: translateX(-50%) translateY(-50%);\n      width: 52%;\n      height: 52%;\n    }\n  '),

  label: cmz.named('AutoUI_Milestones-124', _typo2.default.labelText, '\n      display: block\n      color: ' + _theme2.default.typoHeading + '\n      position: absolute\n      padding-top: 0.5em\n      width: 100%\n      transition: all .25s ease-out\n    ')
};
