...
var Root = _elem2.default.section(cmz.named('AutoUI_RoadmapLevel-27', '\n  & {\n    border: 1px solid ' + _theme2.default.lightBorder + ';\n    padding: 2rem;\n  }\n\n  &:first-child {\n    margin-top: 0;\n  }\n\n  &:last-child {\n    margin-bottom: 0;\n  }\n'));

var active = cmz.named('AutoUI_RoadmapLevel-42', 'border: 1px solid ' + _theme2.default.defaultBorder);
var centered = cmz.named('AutoUI_RoadmapLevel-43', /*cmz|*/'\n  text-align: center;\n  border: none;\n' /*|cmz*/);

// To Do: rewrite the button bellow to use Button component when ready to use it
var Button = _elem2.default.button(cmz.named('AutoUI_RoadmapLevel-49', /*cmz|*/'\n  margin-top: 1rem;\n' /*|cmz*/));
