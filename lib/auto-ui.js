    ...
    value: function render() {
      ...
      return itemsLength > 0 ? _react2.default.createElement(
        ...
        items.map(function (item, i) {
          var isVisible = allVisible || i < realVisible || increment && i < nextView ? cx.item : [cx.item, cx.hidden].join(' ');
          return _react2.default.createElement(
            'li',
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getInitialState = function (_ref, props) {
    var allVisible = _ref.allVisible,
        page = _ref.page;
