...
exports.RoadmapHero = exports.Text = exports.XIcon = exports.SvgIcon = exports.PageTitle = exports.ErrorBox = exports.CollapsibleSection = exports.ApplicantListFilter = exports.ApplicantBadge = undefined;
...
var _RoadmapHero = __webpack_require__(38);
...
var cx = {
  ...
  arrow: cmz.named('AutoUI_CollapsibleSection-28', /*cmz|*/'\n    &::before {\n      content: \'\'\n      position: absolute\n      right: 1rem\n      top: 2rem\n      width: 0\n      height: 0\n      border-style: solid\n    }\n  ' /*|cmz*/),

  arrowDown: cmz.named('AutoUI_CollapsibleSection-40', /*cmz|*/'\n    &::before {\n      border-width: 0 5px 5px 5px\n      border-color: transparent transparent silver transparent\n    }\n  ' /*|cmz*/),

  arrowUp: cmz.named('AutoUI_CollapsibleSection-47', /*cmz|*/'\n    &::before {\n      border-width: 5px 5px 0 5px\n      border-color: silver transparent transparent transparent\n    }\n  ' /*|cmz*/)
};

var Root = _elem2.default.section(cmz.named('AutoUI_CollapsibleSection-55', typo.family.base, '\n  margin: 0\n  padding: 2rem 1rem\n  font-size: 1rem\n  border-top: 1px solid ' + _theme2.default.lightGrayBorder + '\n  position: relative\n'));

var Header = _elem2.default.h1(cmz.named('AutoUI_CollapsibleSection-64', typo.family.smallHeading, cx.arrow, cx.clickable, '\n  & {\n    letter-spacing: normal\n    text-transform: initial\n  }\n\n  .' + cx.twoColSection + ' & {\n    width: 200px\n  }\n\n  &:hover {\n    color: ' + _theme2.default.blackHighlight + '\n  }\n\n  &:hover::before {\n    transform: translateY(-1px)\n  }\n\n  .' + cx.clickable + ':hover &::before {\n    transform: translateY(1px)\n  }\n'));

var Content = _elem2.default.div(cmz.named('AutoUI_CollapsibleSection-90', '\n  .' + cx.twoColSection + ' & {\n    width: calc(100% - 200px)\n  }\n\n  & > :first-child {\n    margin-top: 0\n  }\n'));
...
var CollapsibleSection = function (_PureComponent) {
  ...
  _createClass(CollapsibleSection, [{
    ...
    value: function render() {
      ...
      }, title), Content((isCollapsed || !isCollapsed && !toggleVisible) && visible, !isCollapsed && children));
    }
  }]);
...
var _Graphic = __webpack_require__(39);
...
var LeftBlock = _elem2.default.div(cmz.named('AutoUI_RoadmapHero-34', typo.family.leftBlock, /*cmz|*/'\n  & {\n    float: left;\n    width: 60%;\n  }\n  ' /*|cmz*/));

var RightBlock = _elem2.default.div(cmz.named('AutoUI_RoadmapHero-44', /*cmz|*/'\n  & {\n    float: right;\n  }\n  ' /*|cmz*/));
...
var RoadmapHero = function (_PureComponent) {
  ...
  _createClass(RoadmapHero, [{
    ...
    value: function render() {
      ...
      return Root(LeftBlock(_react2.default.createElement(_Text2.default, { heading: heading, content: content })), RightBlock(_react2.default.createElement(_Graphic2.default, { imgUrl: imgUrl, altText: altText })));
    }
  }]);
...
var _cmz = __webpack_require__(1);
...
var HeroImage = _elem2.default.img(cmz.named('AutoUI_Graphic-16'));

var Graphic = function (_PureComponent) {
  _inherits(Graphic, _PureComponent);
