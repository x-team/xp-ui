...
var styles = {
  ...
  label: cmz.named('AutoUI_Milestones-124', typo.family.base, '\n    & {\n      display: block;\n      text-transform: uppercase;\n      font-size: .8em;\n      font-weight: 400;\n      color: ' + _theme2.default.black + ';\n      position: absolute;\n      padding-top: .2em;\n      width: 100%;\n      transition: all .25s ease-out;\n    }\n  ')
};
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        levels.map(function (level, index) {
          return _this2.renderMilestone(level, ++index);
        })
      );
    }
  }]);
