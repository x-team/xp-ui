...
var textCountStyles = cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-28', '\n  text-align: right\n  color: ' + _theme2.default.lineRed + '\n  height: 40px\n');

var utilStyles = {
  maxWidth: cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-35', /*cmz|*/'max-width: 840px' /*|cmz*/)
};

var editorContainerStyles = cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-38', '\n  & {\n    display: block\n    width: 100%\n    height: 156px\n    padding: 15px\n    margin-bottom: 20px\n    resize: vertical\n    border: 1px solid ' + _theme2.default.lineSilver3 + '\n    overflow: scroll\n    box-sizing: border-box\n  }\n\n  & .editable {\n    height: 100%\n    outline: none\n  }\n\n  & :first-child {\n    margin-top: 0\n  }\n\n  & :last-child {\n    margin-bottom: 0\n  }\n');

var Root = _elem2.default.div([utilStyles.maxWidth, _typo.typeface.text, cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-68', /*cmz|*/'\n    font-weight: 300\n    font-size: 18px\n    text-align: left\n    display: block\n    width: 100%\n    padding: 10px 20px\n    margin-bottom: 20px\n    resize: vertical\n    box-sizing: border-box\n    min-width: 320px\n    margin: 0 auto\n  ' /*|cmz*/)]);
  ...
  function TextareaEditor() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = TextareaEditor.__proto__ || Object.getPrototypeOf(TextareaEditor)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var _this$props = _this.props,
          ...
          hideTextLengthOnBlur = _this$props.hideTextLengthOnBlur;
...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; /* global HTMLElement SyntheticInputEvent */
  ...
  function MediumEditorWrapper() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MediumEditorWrapper.__proto__ || Object.getPrototypeOf(MediumEditorWrapper)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function () {
      ...
      _this.medium.subscribe('blur', subscribeFunction(function (target) {
        console.log('I WAS FIRED');onBlur(target);
      }));
    }, _temp), _possibleConstructorReturn(_this, _ret);
  }
