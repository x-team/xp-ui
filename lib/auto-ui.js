...
var Heading = _elem2.default.h1(cmz.named('AutoUI_Text-30', typo.family.heading));

var SubHeading = _elem2.default.h2(cmz.named('AutoUI_Text-32', /*cmz|*/'\n  font-weight: 600;\n  font-size: 28px;\n  letter-spacing: 1px;\n  font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif;\n  text-transform: uppercase;\n' /*|cmz*/));

var Level = _elem2.default.p(cmz.named('AutoUI_Text-40', '\n  color: ' + _theme2.default.red + ';\n  font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif;\n  font-size: 22px;\n  font-weight: 500;\n'));

var Content = _elem2.default.div(cmz.named('AutoUI_Text-47', typo.family.base, /*cmz|*/'\n  & {\n    margin-top: 35px;\n  }\n  &, & * {\n    font-size: 24px;\n    line-height: 1.3em;\n  }\n' /*|cmz*/));

var dividerLeft = cmz.named('AutoUI_Text-59', typo.family.divider, /*cmz|*/'\n  &:after {\n    left: 3%;\n  }\n' /*|cmz*/);

var dividerCenter = cmz.named('AutoUI_Text-65', typo.family.divider, /*cmz|*/'\n  &:after {\n    left: 50%;\n  }\n' /*|cmz*/);

var centerAlign = cmz.named('AutoUI_Text-71', /*cmz|*/'\n  & {\n    text-align: center;\n  }\n' /*|cmz*/);

var contentDividerLeft = cmz.named('AutoUI_Text-77', typo.family.divider, /*cmz|*/'\n  &:after {\n    left: 3%;\n    top: -30px;\n  }\n' /*|cmz*/);

var contentDividerCenter = cmz.named('AutoUI_Text-84', typo.family.divider, /*cmz|*/'\n  &:after {\n    left: 50%;\n    top: -30px;\n  }\n' /*|cmz*/);
...
var Text = function (_PureComponent) {
  ...
  _createClass(Text, [{
    ...
    value: function render() {
      ...
      return Root(isCentered ? { className: centerAlign } : {}, heading && Heading({ className: isCentered ? dividerCenter : dividerLeft }, heading), subHeading && SubHeading(subHeading), level && Level(level), Content(hasDivider ? { className: isCentered ? contentDividerCenter : contentDividerLeft } : {}, content));
    }
  }]);
...
exports.FooterList = exports.Footer = exports.FooterBrands = exports.Button = exports.VideoPlayer = exports.Milestones = exports.RoadmapLevel = exports.RoadmapHero = exports.Text = exports.HorizontalRuler = exports.HeaderBar = exports.XIcon = exports.SvgIcon = exports.PageTitle = exports.ErrorBox = exports.CollapsibleSection = exports.ApplicantListFilter = exports.ApplicantBadge = undefined;
...
var _RoadmapHero = __webpack_require__(42);

var _RoadmapHero2 = _interopRequireDefault(_RoadmapHero);

var _RoadmapLevel = __webpack_require__(44);
