...
var Root = _elem2.default.section(cmz.named('AutoUI_Text-22', /*cmz|*/'\n  & {\n    white-space: pre-line;\n    margin: 0;\n    clear: both;\n    overflow: hidden;\n  }\n' /*|cmz*/));

var Heading = _elem2.default.h1(cmz.named('AutoUI_Text-31', typo.family.heading, /*cmz|*/'\n  & {\n    padding-bottom: 20px;\n  }\n  ' /*|cmz*/));

var SectionHeading = _elem2.default.h2(cmz.named('AutoUI_Text-40', /*cmz|*/'\n  font-weight: 800;\n  font-size: 36px;\n  padding-top: 64px 0 0 0;\n  letter-spacing: -.025em;\n  font-family: "Open Sans", "Helvetica Neue", Helvetica, Arial, sans-serif;\n  text-transform: uppercase;\n' /*|cmz*/));

var SubHeading = _elem2.default.h3(cmz.named('AutoUI_Text-49', /*cmz|*/'\n  font-weight: 600;\n  font-size: 28px;\n  letter-spacing: 1px;\n  font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif;\n  text-transform: uppercase;\n' /*|cmz*/));

var Level = _elem2.default.p(cmz.named('AutoUI_Text-57', '\n  color: ' + _theme2.default.typoSubheading + ';\n  font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif;\n  font-size: 22px;\n  font-weight: 500;\n'));

var Content = _elem2.default.div(cmz.named('AutoUI_Text-64', typo.family.base, /*cmz|*/'\n  & {\n    margin: 22px 0 50px;\n  }\n  &, & * {\n    font-size: 20px;\n    line-height: 1.3em;\n  }\n' /*|cmz*/));

var centerAlign = cmz.named('AutoUI_Text-76', /*cmz|*/'\n  & {\n    text-align: center;\n  }\n' /*|cmz*/);

var contentDividerLeft = cmz.named('AutoUI_Text-82', typo.family.divider, /*cmz|*/'\n  &:after {\n    left: 3%;\n    top: -30px;\n  }\n' /*|cmz*/);

var contentDividerCenter = cmz.named('AutoUI_Text-89', typo.family.divider, /*cmz|*/'\n  &:after {\n    left: 50%;\n    top: -30px;\n  }\n' /*|cmz*/);
...
var Text = function (_PureComponent) {
  ...
  _createClass(Text, [{
    ...
    value: function render() {
      ...
      return Root(isCentered ? { className: centerAlign } : {}, heading && Heading(heading), sectionHeading && SectionHeading(sectionHeading), subHeading && SubHeading(subHeading), level && Level(level), Content(hasDivider ? { className: isCentered ? contentDividerCenter : contentDividerLeft } : {}, content));
    }
  }]);
...
var baseStyles = {
  ...
  large: cmz.named('AutoUI_Button-99', typo.family.action, /*cmz|*/'\n      font-size: 1em;\n    ' /*|cmz*/),

  small: cmz.named('AutoUI_Button-106', /*cmz|*/'\n    font-size: .65em;\n  ' /*|cmz*/),

  block: cmz.named('AutoUI_Button-110', /*cmz|*/'\n    display: block;\n    margin: 10px auto;\n    width: 200px;\n  ' /*|cmz*/)

  // Button variations
};var extraStyles = {
  disabled: cmz.named('AutoUI_Button-119', '\n    &, &:hover {\n      background: ' + _theme2.default.baseHighlight + ';\n      border-color: transparent;\n      color: ' + _theme2.default.baseBrighter + ';\n      pointer-events: none;\n    }\n  '),

  outlined: cmz.named('AutoUI_Button-128', '\n    & {\n      background-color: transparent;\n    }\n\n    &.' + colorStyles.normal + ' {\n      color: ' + _theme2.default.baseRed + ';\n    }\n\n    &.' + colorStyles.monochrome + ' {\n      color: ' + _theme2.default.baseDarker + ';\n    }\n  ')
};
...
var cx = {
  isActive: cmz.named('AutoUI_ApplicantBadge-20', 'background-color: ' + _theme2.default.baseHighlight)
};
...
var Visible = _elem2.default.div(cmz.named('AutoUI_CollapsibleSection-94', '\n  & {\n    padding-top: 8px\n  }\n\n  .' + cx.twoColSection + ' & {\n    padding: 0 80px 0 0\n  }\n\n  & > :first-child {\n    margin-top: 0\n  }\n\n  & > :last-child {\n    margin-bottom: 0\n  }\n'));

var Children = _elem2.default.div(cmz.named('AutoUI_CollapsibleSection-112', '\n  & {\n    padding: 0 80px 0 32px\n  }\n\n  .' + cx.twoColSection + ' & {\n    padding: 0 80px 0 0\n  }\n\n  & > :first-child {\n    margin-top: 0\n  }\n'));
...
var Root = _elem2.default.section(cmz.named('AutoUI_ColorPalette-13', /*cmz|*/'\n  display: flex\n  flex-wrap: wrap\n  justify-content: center\n' /*|cmz*/));

var Color = _elem2.default.div(cmz.named('AutoUI_ColorPalette-19', typo.family.base, /*cmz|*/'\n    display: flex\n    flex-direction: column\n    justify-content: flex-end\n    width: 170px\n    height: 90px\n    margin: 10px\n    border-radius: 6px\n    box-shadow: 1px 1px 3px rgba(0, 0, 0, .3)\n  ' /*|cmz*/));

var ColorName = _elem2.default.div(cmz.named('AutoUI_ColorPalette-33', '\n  background-color: ' + _theme2.default.baseBrighter + '\n  padding: 4px\n  text-align: center\n  border-radius: 0 0 6px 6px\n'));
