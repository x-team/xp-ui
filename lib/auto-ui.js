...
var breakpoints = {
  medium: '@media screen and (max-width: ' + _theme.breakpoints.md + ')',
  desktop: '@media screen and (min-width: ' + _theme.breakpoints.md + ')'
};

var cx = {
  link: cmz.named('AutoUI_ui_Footer_FooterList-27', _typo.typeface.text, '\n      font-size: 1rem\n      font-weight: 400\n      color: ' + _theme2.default.baseDarker + '\n      text-decoration: none\n    '),

  item: cmz.named('AutoUI_ui_Footer_FooterList-37', '\n    & {\n      margin-bottom: 1em\n    }\n\n    ' + breakpoints.medium + ' {\n      & {\n        margin: 1em 0\n      }\n    }\n  '),

  list: cmz.named('AutoUI_ui_Footer_FooterList-49', /*cmz|*/'\n    list-style: none\n    margin: 0\n    padding: 0\n  ' /*|cmz*/),

  title: cmz.named('AutoUI_ui_Footer_FooterList-55', _typo.typeface.text, '\n      & {\n        font-size: 1.25rem\n        font-weight: 400\n        text-transform: uppercase\n        color: ' + _theme2.default.baseDarker + '\n        margin: 0 0 2em\n      }\n\n      ' + breakpoints.medium + ' {\n        &:not(:nth-child(2)) {\n          display: none\n        }\n      }\n    '),
