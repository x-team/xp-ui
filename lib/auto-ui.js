...
var baseStyles = {
  ...
  pseudolink: cmz.named('AutoUI_ui_Button-170', '\n    &.pseudolink {\n      border-color: transparent\n      color: ' + _theme2.default.typoLabel + '\n    }\n\n    &.pseudolink span {\n      text-transform: initial\n    }\n\n    &.pseudolink:hover {\n      background-color: ' + _theme2.default.lineSilver2.darken(0.025) + '\n      border-color: ' + _theme2.default.lineSilver2.darken(0.025) + '\n    }\n  '),

  selected: cmz.named('AutoUI_ui_Button-186', '\n    & {\n      border-color: ' + _theme2.default.baseRed + '\n    }\n\n    &.outlined.raised:hover {\n      box-shadow: none\n      border-color: ' + _theme2.default.baseRed + '\n    }\n  ')
};
  ...
  _createClass(Button, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['className', 'size', 'color', 'outlined', 'disabled', 'rounded', 'raised', 'pseudolink', 'selected', 'block', 'component', 'children']);

      var colorClassName = colorStyles[color] || '';
      var sizeClassName = sizeStyles[size] || '';
      var extraClassName = [outlined && extraStyles.outlined, outlined && 'outlined', rounded && extraStyles.rounded, rounded && 'rounded', raised && extraStyles.raised, raised && 'raised', pseudolink && [extraStyles.outlined, extraStyles.pseudolink].join(' '), pseudolink && 'outlined pseudolink', selected && extraStyles.selected, selected && 'selected', block && extraStyles.block, disabled && extraStyles.disabled].filter(Boolean).join(' ');
...
var cardTheme = {
  mode: cmz.named('AutoUI_ui_ApplicantBadge-42', _typo2.default.baseText, '\n      & {\n        transition: all 0.4s ease-out\n        background: ' + _theme2.default.baseBrighter + '\n        border: 1px solid ' + _theme2.default.lineSilver2 + '\n        padding: 30px\n        display: grid\n        grid-template: \'avatar name control\' \'avatar infos infos\' \'tags tags tags\'\n        grid-template-columns: 90px 1fr auto\n        grid-template-rows: minmax(20px, auto) auto auto\n        grid-gap: 15px\n        margin: 0 10px\n        cursor: pointer\n      }\n\n      &:hover {\n        box-shadow: 0 1px 8px rgba(0, 0, 0, 0.2)\n      }\n    '),

  active: cmz.named('AutoUI_ui_ApplicantBadge-65', '\n    transition: all 0.2s ease-in\n    border: 1px solid ' + _theme2.default.baseRed + '\n    box-shadow: 0 1px 8px rgba(0, 0, 0, 0.2)\n    margin: 0\n    padding: 30px 40px\n  '),

  name: cmz.named('AutoUI_ui_ApplicantBadge-73', _typo2.default.badgeHeading, /*cmz|*/'\n      grid-area: name\n      display: flex\n      align-items: flex-end\n      font-size: 17px\n    ' /*|cmz*/),

  avatar: cmz.named('AutoUI_ui_ApplicantBadge-82', /*cmz|*/'\n    grid-area: avatar\n    width: 90px\n    height: 90px\n  ' /*|cmz*/),

  control: cmz.named('AutoUI_ui_ApplicantBadge-88', '\n    & {\n      display: inline-block\n      padding: 0\n      margin: 0 0 0 5px\n      border: 0\n      border-radius: 2px\n      cursor: pointer\n      width: 20px\n      height: 20px\n      text-align: center\n      line-height: 1\n    }\n\n    &:hover {\n      background: ' + _theme2.default.baseRed + '\n    }\n\n    &:hover svg g,\n    &:hover svg polyline {\n      stroke: white\n    }\n  '),

  controls: cmz.named('AutoUI_ui_ApplicantBadge-112', 'controls', /*cmz|*/'\n    grid-area: control\n    display: flex\n    visibility: hidden\n  ' /*|cmz*/),

  displayControlsOnHover: cmz.named('AutoUI_ui_ApplicantBadge-118', /*cmz|*/'\n    &:hover .controls {\n      visibility: visible\n    }\n  ' /*|cmz*/),

  infos: cmz.named('AutoUI_ui_ApplicantBadge-124', /*cmz|*/'\n    grid-area: infos\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: flex-start\n    margin: 0 0 -10px\n  ' /*|cmz*/),

  info: cmz.named('AutoUI_ui_ApplicantBadge-133', _typo2.default.baseText, /*cmz|*/'\n      & {\n        margin: 0 20px 10px 0\n      }\n\n      &:last-of-type {\n        margin-right: 0\n      }\n    ' /*|cmz*/),

  moreinfos: cmz.named('AutoUI_ui_ApplicantBadge-145', '\n    & {\n      color: ' + _theme2.default.typoLabel + '\n      font-size: 17px\n      margin: 0 0 10px 0\n      cursor: pointer\n      align-self: flex-end\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),

  label: cmz.named('AutoUI_ui_ApplicantBadge-159', '\n    display: block\n    color: ' + _theme2.default.typoLabel + '\n    white-space: nowrap\n    line-height: 1.2\n    font-size: 17px\n  '),

  value: cmz.named('AutoUI_ui_ApplicantBadge-167', '\n    display: block\n    color: ' + _theme2.default.typoParagraph + '\n    line-height: 1.2\n    font-size: 17px\n    white-space: normal\n  '),

  tip: cmz.named('AutoUI_ui_ApplicantBadge-175', '\n    font-size: 15px\n    color: ' + _theme2.default.typoParagraph + '\n    line-height: 1.4\n  '),

  tags: cmz.named('AutoUI_ui_ApplicantBadge-181', /*cmz|*/'\n    font-size: 14px\n    grid-area: tags\n    width: 100%\n    display: flex\n    flex-wrap: wrap\n    align-items: start\n    margin: 0 0 -10px\n  ' /*|cmz*/),

  tag: cmz.named('AutoUI_ui_ApplicantBadge-191', '\n    & {\n      border: 1px solid ' + _theme2.default.lineSilver2 + '\n      border-radius: 3px\n      padding: 0 10px\n      text-transform: uppercase\n      margin: 0 10px 10px 0\n      white-space: nowrap\n      color: ' + _theme2.default.typoParagraph + '\n    }\n\n    &:last-of-type {\n      margin-right: 0\n    }\n  '),

  moretags: cmz.named('AutoUI_ui_ApplicantBadge-207', '\n    & {\n      border: none\n      padding: 0 0 0 20px\n      text-transform: initial\n      margin: 0 0 10px 0\n      cursor: pointer\n    }\n\n    &:hover {\n      color: ' + _theme2.default.typoHighlight + '\n    }\n  '),

  purelabel: cmz.named('AutoUI_ui_ApplicantBadge-221', '\n    border: none\n    color: ' + _theme2.default.typoLabel + '\n    font-size: 17px\n  '),

  children: cmz.named('AutoUI_ui_ApplicantBadge-227', /*cmz|*/'\n    grid-column: 1 / -1\n    grid-row: 4 / -1\n  ' /*|cmz*/)
};
        ...
        _react2.default.createElement(
          ...
          displayApprovalIcon && _react2.default.createElement(
            _Dropdown2.default,
            {
              ...
              label: _react2.default.createElement(
                'span',
                { className: cx.control, onClick: onClickApprovalIcon },
          ...
          displayExclusionIcon && _react2.default.createElement(
            _Dropdown2.default,
            {
              ...
              label: _react2.default.createElement(
                'span',
                { className: cx.control, onClick: onClickExclusionIcon },
  ...
  _createClass(MilestonesScreen, [{
    ...
    value: function render() {
      ...
      var milestones = level > 0 && _react2.default.createElement(_Milestones2.default, {
        level: level,
        levels: [{ icon: 'cog' }, { icon: 'message' }, { icon: 'webcam' }]
      });
...
var styles = {
  ...
  item: cmz.named('AutoUI_ui_SelectBox-148', _typo2.default.baseText, /*cmz|*/'\n    & {\n      min-height: 30px\n      margin: 22px\n      display: flex\n      justify-content: space-between\n      align-items: center\n    }\n\n    &:last-child {\n      border-bottom: none\n    }\n\n    &:not(.isSaving):not(.isSelecting):hover .editButton {\n      display: flex\n    }\n  ' /*|cmz*/),
  lined: cmz.named('AutoUI_ui_SelectBox-165', '\n    border-bottom: 1px solid ' + _theme2.default.lineSilver2 + '\n    margin: 0 22px\n    padding: 15px 0\n  '),
  editing: cmz.named('AutoUI_ui_SelectBox-170', '\n    & input {\n      border-bottom: 1px solid ' + _theme2.default.baseRed + '\n    }\n  '),
  control: cmz.named('AutoUI_ui_SelectBox-175', /*cmz|*/'\n    flex-shrink: 0\n    display: flex\n  ' /*|cmz*/),
  controlbutton: cmz.named('AutoUI_ui_SelectBox-179', /*cmz|*/'\n    cursor: pointer\n    padding: 5px\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  editButton: cmz.named('AutoUI_ui_SelectBox-185', 'editButton', /*cmz|*/'\n    display: none\n  ' /*|cmz*/),
  selecting: cmz.named('AutoUI_ui_SelectBox-188', _typo2.default.baseText, /*cmz|*/'\n      padding: 0 0 0 30px\n      position: relative\n    ' /*|cmz*/),
  selectingdots: cmz.named('AutoUI_ui_SelectBox-195', '\n    & {\n      position: absolute\n      top: calc(50% - 9px)\n      left: 0\n      width: 20px\n      height: 20px\n      border-top-color: ' + _theme2.default.lineSilver2 + '\n      border-left-color: ' + _theme2.default.lineSilver2 + '\n      animation: spinner 400ms linear infinite\n      border-bottom-color: transparent\n      border-right-color: transparent\n      border-style: solid\n      border-width: 2px\n      border-radius: 50%\n      box-sizing: border-box\n      display: inline-block\n      vertical-align: middle\n    }\n\n    @keyframes spinner {\n      0% {\n        transform: rotate(0deg)\n      }\n      100% {\n        transform: rotate(360deg)\n      }\n    }\n  '),
  editinput: cmz.named('AutoUI_ui_SelectBox-224', _typo2.default.baseText, /*cmz|*/'\n      & {\n        width: 70%\n        height: 30px\n      }\n\n      & input {\n        height: 30px\n        padding: 0\n        border-top: none\n        border-right: none\n        border-left: none\n      }\n    ' /*|cmz*/),
  nothinglabel: cmz.named('AutoUI_ui_SelectBox-241', _typo2.default.baseText, /*cmz|*/'\n      display: block\n      margin: 15px 22px\n    ' /*|cmz*/),
  createnew: cmz.named('AutoUI_ui_SelectBox-248', _typo2.default.baseText, '\n      & {\n        display: flex\n        align-items: center\n        margin: 15px 22px\n        color: ' + _theme2.default.baseRed + '\n        cursor: pointer\n      }\n\n      & svg {\n        transform: scale(0.7)\n        margin-right: 8px\n      }\n    ')
};
