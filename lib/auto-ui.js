...
var utilStyles = {
  maxWidth: cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-20', /*cmz|*/'max-width: 840px' /*|cmz*/)
};

var editorContainerStyles = cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-23', '\n  & {\n    display: block\n    width: 100%\n    height: 156px\n    padding: 15px\n    margin-bottom: 20px\n    resize: vertical\n    border: 1px solid ' + _theme2.default.lineSilver3 + '\n    overflow: scroll\n    box-sizing: border-box\n  }\n\n  & .editable {\n    height: 100%\n    outline: none\n  }\n\n  & :first-child {\n    margin-top: 0\n  }\n\n  & :last-child {\n    margin-bottom: 0\n  }\n');

var Root = _elem2.default.div([utilStyles.maxWidth, _typo.typeface.text, cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-53', /*cmz|*/'\n    font-weight: 300\n    font-size: 18px\n    text-align: left\n    display: block\n    width: 100%\n    margin-bottom: 20px\n    resize: vertical\n    box-sizing: border-box\n    min-width: 320px\n    margin: 0 auto\n  ' /*|cmz*/)]);
