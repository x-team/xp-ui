...
var normalizeLink = __webpack_require__(21);
...
var _CollapsibleSection = __webpack_require__(40);
...
var _HeaderBar = __webpack_require__(14);

var _HeaderBar2 = _interopRequireDefault(_HeaderBar);

var _HorizontalRuler = __webpack_require__(53);
...
var _Typography = __webpack_require__(62);

var _Typography2 = _interopRequireDefault(_Typography);

var _VideoPlayer = __webpack_require__(63);

var _VideoPlayer2 = _interopRequireDefault(_VideoPlayer);

var _XIcon = __webpack_require__(64);
...
var _SolutionForm = __webpack_require__(69);

var _SolutionForm2 = _interopRequireDefault(_SolutionForm);

var _MarkdownTextarea = __webpack_require__(71);
...
exports.MarkdownTextarea = _MarkdownTextarea2.default;
...
var _recompose = __webpack_require__(41);
...
var _reactRemarkable = __webpack_require__(72);
...
var mdContainerStyles = cmz.named('AutoUI_ui_MarkdownTextarea-29', '\n  & {\n    min-height: 154px\n    border: 1px solid ' + _theme2.default.lineSilver3 + '\n    padding: 0 20px\n  }\n\n  & p {\n    padding: 10px 0px\n    margin: 0\n  }\n');

var textCountStyles = cmz.named('AutoUI_ui_MarkdownTextarea-42', '\n  text-align: right\n  color: ' + _theme2.default.lineRed + '\n');

var active = cmz.named('AutoUI_ui_MarkdownTextarea-47', '\n  border: 1px solid ' + _theme2.default.lineSilver3 + ' !important\n  border-bottom: 0 !important\n  background-color: ' + _theme2.default.baseBrighter + ' !important\n');

var navStyles = cmz.named('AutoUI_ui_MarkdownTextarea-53', /*cmz|*/'\n  margin-bottom: -1px\n  padding: 0 10px\n' /*|cmz*/);

var navContainerStyles = cmz.named('AutoUI_ui_MarkdownTextarea-58', '\n  margin-bottom: 10px\n  border-bottom: 1px solid ' + _theme2.default.lineSilver3 + '\n');

var navButtonStyles = cmz.named('AutoUI_ui_MarkdownTextarea-63', /*cmz|*/'\n  background-color: transparent\n  font-size: 14px;\n  border-radius: 3px 3px 0 0\n  border: 0\n  padding: 8px 12px\n  outline: none\n  cursor: pointer\n' /*|cmz*/);

var utilStyles = {
  maxWidth: cmz.named('AutoUI_ui_MarkdownTextarea-74', /*cmz|*/'max-width: 840px' /*|cmz*/),
  noOutline: cmz.named('AutoUI_ui_MarkdownTextarea-75', /*cmz|*/'outline: none' /*|cmz*/)
};

var textareaStyles = [utilStyles.noOutline, _typo2.default.formText, cmz.named('AutoUI_ui_MarkdownTextarea-81', '\n    & {\n      display: block\n      width: 100%\n      height: 156px\n      padding: 10px 20px\n      margin-bottom: 20px\n      resize: vertical\n      border: 1px solid ' + _theme2.default.lineSilver3 + '\n      box-sizing: border-box\n    }\n\n    &::-webkit-input-placeholder {\n      color: ' + _theme2.default.formPlaceholder + '\n    }\n\n    &::-moz-placeholder {\n      color: ' + _theme2.default.formPlaceholder + '\n    }\n  ')];

var Root = _elem2.default.div([utilStyles.maxWidth, cmz.named('AutoUI_ui_MarkdownTextarea-105', /*cmz|*/'\n    font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif\n    font-weight: 300\n    font-size: 18px\n    text-align: left\n    min-width: 320px\n    margin: 0 auto\n  ' /*|cmz*/)]);
...
var MarkdownContainer = function MarkdownContainer(props) {
  return _react2.default.createElement(
    'div',
    { className: textareaStyles + ' ' + mdContainerStyles },
    props.children
  );
};

var MarkdownTextarea = function (_PureComponent) {
  _inherits(MarkdownTextarea, _PureComponent);
  ...
  function MarkdownTextarea() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MarkdownTextarea.__proto__ || Object.getPrototypeOf(MarkdownTextarea)).call.apply(_ref, [this].concat(args))), _this), _this.WRITE_BUTTON_TEXT = 'Write', _this.PREVIEW_BUTTON_TEXT = 'Preview', _this.state = {
      text: '',
      currentButton: 'Write',
    ...
    }, _this.onBlur = function (_ref4) {
      var target = _ref4.target;

      _this.setState({
        shouldShowTextLength: false
      });
      var onUnfocus = _this.props.onUnfocus;

      if (onUnfocus) {
        onUnfocus(target);
      }
    }, _this.handleTabChange = function (_ref5) {
      var name = _ref5.target.name;
      var currentButton = _this.state.currentButton;
  ...
  _createClass(MarkdownTextarea, [{
    ...
    value: function render() {
      ...
      var showingComponent = currentButton === this.WRITE_BUTTON_TEXT ? Textarea({
        maxLength: charLimit,
      ...
      }) : _react2.default.createElement(_reactRemarkable2.default, { source: text || 'No preview available.', container: MarkdownContainer });
...
var _remarkable = __webpack_require__(73);
...
var ParserInline = __webpack_require__(103);
...
var rules = __webpack_require__(76);
...
var _rules = [
  [ 'block',          __webpack_require__(78)          ],
  [ 'abbr',           __webpack_require__(79)           ],
  [ 'references',     __webpack_require__(80)     ],
  [ 'inline',         __webpack_require__(81)         ],
  [ 'footnote_tail',  __webpack_require__(82)  ],
  [ 'abbr2',          __webpack_require__(83)          ],
  [ 'replacements',   __webpack_require__(84)   ],
  [ 'smartquotes',    __webpack_require__(85)    ],
  [ 'linkify',        __webpack_require__(86)        ]
];
...
var StateInline    = __webpack_require__(11);
...
var normalizeReference   = __webpack_require__(23);
...
var Autolinker = __webpack_require__(87);
...
var Ruler      = __webpack_require__(8);
var StateBlock = __webpack_require__(89);
...
var _rules = [
  [ 'code',       __webpack_require__(90) ],
  [ 'fences',     __webpack_require__(91),     [ 'paragraph', 'blockquote', 'list' ] ],
  [ 'blockquote', __webpack_require__(92), [ 'paragraph', 'blockquote', 'list' ] ],
  [ 'hr',         __webpack_require__(93),         [ 'paragraph', 'blockquote', 'list' ] ],
  [ 'list',       __webpack_require__(94),       [ 'paragraph', 'blockquote' ] ],
  [ 'footnote',   __webpack_require__(95),   [ 'paragraph' ] ],
  [ 'heading',    __webpack_require__(96),    [ 'paragraph', 'blockquote' ] ],
  [ 'lheading',   __webpack_require__(97) ],
  [ 'htmlblock',  __webpack_require__(98),  [ 'paragraph', 'blockquote' ] ],
  [ 'table',      __webpack_require__(100),      [ 'paragraph' ] ],
  [ 'deflist',    __webpack_require__(101),    [ 'paragraph' ] ],
...
var block_names = __webpack_require__(99);
...
var _rules = [
  ...
  [ 'newline',         __webpack_require__(105) ],
  [ 'escape',          __webpack_require__(106) ],
  [ 'backticks',       __webpack_require__(107) ],
  [ 'del',             __webpack_require__(108) ],
  [ 'ins',             __webpack_require__(109) ],
  [ 'mark',            __webpack_require__(110) ],
  [ 'emphasis',        __webpack_require__(111) ],
  [ 'sub',             __webpack_require__(112) ],
  [ 'sup',             __webpack_require__(113) ],
  [ 'links',           __webpack_require__(114) ],
  [ 'footnote_inline', __webpack_require__(115) ],
  [ 'footnote_ref',    __webpack_require__(116) ],
  [ 'autolink',        __webpack_require__(117) ],
  [ 'htmltag',         __webpack_require__(119) ],
  [ 'entity',          __webpack_require__(121) ]
];
...
var url_schemas   = __webpack_require__(118);
var normalizeLink = __webpack_require__(21);
...
var HTML_TAG_RE = __webpack_require__(120).HTML_TAG_RE;
