...
var cx = {
  ...
  columnContainer: cmz.named('AutoUI_ui_Footer_Footer-29', /*cmz|*/'\n    display: flex;\n    max-width: 1280px;\n    margin: 0 auto;\n    padding: 0 20px;\n  ' /*|cmz*/, /*cmz|*/'\n  @media screen and (max-width: 1024px) { & {\n    justify-content: center;\n  } }\n  ' /*|cmz*/),
  logoColumn: cmz.named('AutoUI_ui_Footer_Footer-40', /*cmz|*/'\n    width: 20%;\n  ' /*|cmz*/, /*cmz|*/'\n  @media screen and (max-width: 1024px) { & {\n    display: none;\n  } }\n  ' /*|cmz*/),
  column: cmz.named('AutoUI_ui_Footer_Footer-48', /*cmz|*/'\n    flex-grow: 1;\n    max-width: 28%;\n  ' /*|cmz*/, /*cmz|*/'\n  @media screen and (max-width: 1024px) { &:not(:nth-child(2)) {\n    display: none\n  }\n  & {\n    text-align: center\n    line-height: 1.75rem;\n  }\n  }\n  ' /*|cmz*/),
  colophon: cmz.named('AutoUI_ui_Footer_Footer-62', '\n    flex-grow: 1;\n    max-width: 72%;\n    margin-top: 3.125rem;\n    padding-top: 2.5rem;\n    border-top: 1px solid ' + _theme2.default.lineSilver2 + '\n  '),
  copyright: cmz.named('AutoUI_ui_Footer_Footer-69', '\n    font-size: 0.75rem;\n    opacity: 0.5;\n    line-height: 0;\n    color: ' + _theme2.default.baseDarker + '\n  ', _typo2.default.baseText)
};
...
var cx = {
  ...
  list: cmz.named('AutoUI_ui_Footer_FooterList-32', /*cmz|*/'\n    list-style: none;\n    margin: 0;\n    padding: 0;\n  ' /*|cmz*/),
  title: cmz.named('AutoUI_ui_Footer_FooterList-37', '\n    font-family: "Source Sans Pro", "Helvetica Neue", Helvetica, Arial, sans-serif;\n    font-size: 1.25rem;\n    text-transform: uppercase;\n    color: ' + _theme2.default.baseDarker + '\n    margin: 0 0 2em;\n  ', /*cmz|*/'\n  @media screen and (max-width: 1024px) { &:not(:nth-child(2)) {\n    display: none\n  } }\n  ' /*|cmz*/),
  mobile: cmz.named('AutoUI_ui_Footer_FooterList-49', /*cmz|*/'\n    @media screen and (min-width: 1024px) { & {\n      display: none\n    } }\n  ' /*|cmz*/)
};
