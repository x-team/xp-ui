...
var _FilterBar = __webpack_require__(46);
...
var _HorizontalRuler = __webpack_require__(47);
...
var _InputGroup = __webpack_require__(48);
...
var _MilestonesScreen = __webpack_require__(49);
...
var _RoadmapHero = __webpack_require__(53);

var _RoadmapHero2 = _interopRequireDefault(_RoadmapHero);

var _RoadmapLevel = __webpack_require__(55);
...
var _Typography = __webpack_require__(56);
...
var _XIcon = __webpack_require__(58);
...
var _SolutionForm = __webpack_require__(63);
...
var textCountStyles = cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-24', '\n  text-align: right\n  color: ' + _theme2.default.lineRed + '\n  height: 40px\n');

var utilStyles = {
  maxWidth: cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-31', /*cmz|*/'max-width: 840px' /*|cmz*/)
};

var editorContainerStyles = cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-34', '\n  & {\n    display: block\n    width: 100%\n    height: 156px\n    padding: 15px\n    margin-bottom: 20px\n    resize: vertical\n    border: 1px solid ' + _theme2.default.lineSilver3 + '\n    overflow: scroll\n    box-sizing: border-box\n  }\n\n  & .editable {\n    height: 100%\n    outline: none\n  }\n\n  & :first-child {\n    margin-top: 0\n  }\n\n  & :last-child {\n    margin-bottom: 0\n  }\n');

var Root = _elem2.default.div([utilStyles.maxWidth, _typo.typeface.text, cmz.named('AutoUI_ui_TextareaEditor_TextareaEditor-64', /*cmz|*/'\n    font-weight: 300\n    font-size: 18px\n    text-align: left\n    display: block\n    width: 100%\n    padding: 10px 20px\n    margin-bottom: 20px\n    resize: vertical\n    box-sizing: border-box\n    min-width: 320px\n    margin: 0 auto\n  ' /*|cmz*/)]);
...
var MediumEditorWrapper = function (_PureComponent) {
  ...
  function MediumEditorWrapper() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = MediumEditorWrapper.__proto__ || Object.getPrototypeOf(MediumEditorWrapper)).call.apply(_ref, [this].concat(args))), _this), _this.componentDidUpdate = function () {
      ...
      var charLimit = _this.props.charLimit;

      var defaultOptions = {};
      if (charLimit) {
        var PasteWithCharLimitExtension = pasteWithCharLimitExtension(_this.props.charLimit);
        defaultOptions.extensions = {
          paste: new PasteWithCharLimitExtension()
        };
      }
      console.log(defaultOptions);
      _this.medium = new MediumEditor('.editable', _extends({}, defaultOptions, _this.props.options));
