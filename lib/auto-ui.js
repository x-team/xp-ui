...
var FilesList = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-32', /*cmz|*/'\n  margin-bottom: 30px\n' /*|cmz*/));

var FileItem = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-36', '\n  position: relative\n  display: flex\n  align-items: start\n  height: 20px\n  margin-bottom: 20px\n  border-bottom: 2px solid ' + _theme2.default.baseSilver + '\n'));

var FileName = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-45', _typo2.default.baseText, /*cmz|*/'\n    width: 100%\n    font-size: 16px\n    line-height: 1\n  ' /*|cmz*/));

var FileAction = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-54', /*cmz|*/'\n  cursor: pointer\n' /*|cmz*/));

var FileProgress = _elem2.default.div(cmz.named('AutoUI_ui_AttachFiles-58', '\n  position: absolute\n  bottom: -2px\n  display: block\n  height: 2px\n  width: 0\n  background-color: ' + _theme2.default.baseRed + '\n  transition: width 0.5s\n'));

var ButtonLabel = _elem2.default.span(cmz.named('AutoUI_ui_AttachFiles-68', /*cmz|*/'\n  padding: 0 20px\n' /*|cmz*/));
