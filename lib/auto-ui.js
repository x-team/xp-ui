...
var styles = {
  ...
  padded: cmz.named('AutoUI_ui_Dropdown-43', /*cmz|*/'\n    padding: 10px\n  ' /*|cmz*/),
  triangle: cmz.named('AutoUI_ui_Dropdown-46', /*cmz|*/'\n    transform: translateY(-3px)\n  ' /*|cmz*/),
  content: cmz.named('AutoUI_ui_Dropdown-49', /*cmz|*/'\n    position: absolute\n    z-index: 999\n    visibility: hidden\n    opacity: 0\n    transition: visibility 0s linear 0.2s, opacity 0.2s linear\n    width: inherit\n  ' /*|cmz*/),
  contentvisible: cmz.named('AutoUI_ui_Dropdown-57', /*cmz|*/'\n    visibility: visible\n    opacity: 1\n    transition-delay: 0s\n  ' /*|cmz*/),
  contentright: cmz.named('AutoUI_ui_Dropdown-62', /*cmz|*/'\n    right: 0\n  ' /*|cmz*/)
};
    ...
    value: function render() {
      ...
      return children || label || icon ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: labelClasses, onClick: this.toggle },
...
var styles = {
  ...
  label: cmz.named('AutoUI_ui_SelectBox-69', _typo2.default.baseText, /*cmz|*/'\n      line-height: 1\n    ' /*|cmz*/),
  list: cmz.named('AutoUI_ui_SelectBox-75', /*cmz|*/'\n    list-style: none\n    margin: 0\n    padding: 0\n    border: 1px solid #E9EDEE\n    border-top: none\n    overflow-y: scroll\n    background: #fff\n    width: 100%\n    box-sizing: border-box\n  ' /*|cmz*/),
  shadow: cmz.named('AutoUI_ui_SelectBox-86', /*cmz|*/'\n    box-shadow: 0 5px 12px rgba(0, 0, 0, 0.15)\n  ' /*|cmz*/),
  item: cmz.named('AutoUI_ui_SelectBox-89', /*cmz|*/'\n    & {\n      min-height: 30px\n      margin: 22px\n      display: flex\n      justify-content: space-between\n      align-items: center\n    }\n\n    &:last-child {\n      border-bottom: none\n    }\n  ' /*|cmz*/),
  lined: cmz.named('AutoUI_ui_SelectBox-102', /*cmz|*/'\n    border-bottom: 1px solid #E9EDEE\n    margin: 0 22px\n    padding: 15px 0\n  ' /*|cmz*/),
  control: cmz.named('AutoUI_ui_SelectBox-107', /*cmz|*/'\n    flex-shrink: 0\n    display: flex\n  ' /*|cmz*/),
  controlbutton: cmz.named('AutoUI_ui_SelectBox-111', /*cmz|*/'\n    cursor: pointer\n    padding: 5px\n    display: flex\n    align-items: center\n  ' /*|cmz*/),
  editinput: cmz.named('AutoUI_ui_SelectBox-117', _typo2.default.baseText, /*cmz|*/'\n      & {\n        width: 70%\n        height: 30px\n      }\n\n      & input {\n        height: 30px\n        padding: 0\n        border-top: none\n        border-right: none\n        border-left: none\n      }\n    ' /*|cmz*/),
  nothinglabel: cmz.named('AutoUI_ui_SelectBox-134', _typo2.default.baseText, /*cmz|*/'\n      display: block\n      margin: 15px 22px\n    ' /*|cmz*/),
  createnew: cmz.named('AutoUI_ui_SelectBox-141', _typo2.default.baseText, '\n      & {\n        display: flex\n        align-items: center\n        margin: 15px 22px\n        color: ' + _theme2.default.baseRed + '\n        cursor: pointer\n      }\n\n      & svg {\n        transform: scale(0.7)\n        margin-right: 8px\n      }\n    ')
};

var SelectBox = function (_PureComponent) {
  _inherits(SelectBox, _PureComponent);
  ...
  function SelectBox() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SelectBox.__proto__ || Object.getPrototypeOf(SelectBox)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
      ...
      var newItems = items && items.map(function (each, i) {
      ...
      var match = new RegExp(value.trim().toUpperCase(), 'g');
      var filteredItems = items && items.map(function (item) {
        var itemMatch = item && item.value && item.value.toUpperCase().match(match);
        return _extends({}, item, {
          hidden: !(itemMatch && itemMatch.length > 0)
        });
      });
      _this.setState({ search: value, items: filteredItems });
    }, _this.handleSelect = function (item) {
      var onSelect = _this.props.onSelect;

      var updatedItem = _extends({}, item, { selected: !item.selected });
      if (onSelect) {
      ...
      var updatedItem = _extends({}, item, { value: item.editing, editing: '' });
      if (onEdit) {
        onEdit(updatedItem);
        _this.updateItemsState(updatedItem);
      }
  ...
  _createClass(SelectBox, [{
    ...
    value: function render() {
      ...
      var renderCheckboxOrString = function renderCheckboxOrString(item) {
        return onSelect ? _react2.default.createElement(_InputField2.default, {
          type: 'checkbox',
          label: item.value,
          name: item.value,
      ...
      var itemClasses = [styles.item, expanded ? '' : styles.lined].join(' ');
      var renderIsEditing = function renderIsEditing(item) {
        return !item.editing ? _react2.default.createElement(
          'li',
          { className: itemClasses, key: item.id },
      ...
      return _react2.default.createElement(
        ...
        expanded ? _react2.default.createElement(
          ...
          _Dropdown2.default,
          { label: renderSearchLabel(), className: styles.dropdown },
          renderItems()
        )
      );
    }
